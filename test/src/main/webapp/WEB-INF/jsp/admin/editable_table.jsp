...
<head>
   <meta charset="utf-8" />
   <title>Metro风格响应式后台管理系统模板MetroAdmin 可编辑表格 - JS代码网</title>
   ...
   <link rel="stylesheet" href="../static/win8/assets/data-tables/DT_bootstrap.css" />
...
<body class="fixed-top">
              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu active">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a class="" href="editable_table.jsp">Editable Table</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
   ...
   <script src="../static/win8/js/editable-table.js"></script>
