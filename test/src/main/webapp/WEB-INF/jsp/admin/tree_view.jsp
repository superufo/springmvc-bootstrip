...
<head>
   <meta charset="utf-8" />
   <title>Metro风格响应式后台管理系统模板MetroAdmin 树形菜单- JS代码网</title>
   ...
   <link rel="stylesheet" type="text/css" href="../static/win8/assets/bootstrap-tree/bootstrap-tree/css/bootstrap-tree.css" />
</head>
<!-- END HEAD -->
<!-- BEGIN BODY -->
<body class="fixed-top">
              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu active">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a class="" href="tree_view.jsp">Tree View</a></li>
                            ...
                            <ul id="tree_2" class="tree">
                                <li>
                                    ...
                                    <ul class="branch in">
                                        ...
                                        <li>
                                            <a data-value="XML_Example" data-toggle="branch" class="tree-toggle closed" data-role="branch" href="../static/win8/assets/bootstrap-tree/xmlexample.xml">Load data from XML document via Ajax
                                            </a>
                                            <ul class="branch">
                                        ...
                                        <li>
                                            <a data-value="HTML_Example" data-toggle="branch" class="tree-toggle closed" data-role="branch" href="../static/win8/assets/bootstrap-tree/htmlexample.jsp">Load data from HTML page via Ajax
                                        ...
                                        <li><a data-value="JSON_Example" data-toggle="branch" class="tree-toggle closed" data-role="branch" href="../static/win8/assets/bootstrap-tree/jsonexample.json">Load data from JSON via Ajax</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
   ...
   <script src="../static/win8/assets/bootstrap-tree/bootstrap-tree/js/bootstrap-tree.js"></script>
   ...
   <script src="../static/win8/js/tree.js"></script>
