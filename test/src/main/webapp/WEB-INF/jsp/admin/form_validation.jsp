...
<head>
    <meta charset="utf-8" />
    <title>Metro风格响应式后台管理系统模板MetroAdmin 表单验证 - JS代码网</title>
...
<body class="fixed-top">
              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu active">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a class="" href="form_validation.jsp">Form Validation</a></li>
   ...
   <script src="../static/win8/assets/bootstrap-wizard/jquery.bootstrap.wizard.min.js"></script>
   ...
   <![endif]-->
   <script type="text/javascript" src="../static/win8/js/jquery.validate.min.js"></script>
   <script type="text/javascript" src="../static/win8/js/additional-methods.min.js"></script>
   ...
   <script src="../static/win8/js/form-validation-script.js"></script>
