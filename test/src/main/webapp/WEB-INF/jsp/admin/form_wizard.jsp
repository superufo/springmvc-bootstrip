...
<head>
    <meta charset="utf-8" />
    <title>Metro风格响应式后台管理系统模板MetroAdmin 表单提示 - JS代码网</title>
...
<body class="fixed-top">
              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu active">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a class="" href="form_wizard.jsp">Form Wizard</a></li>
   ...
   <script src="../static/win8/js/form-wizard.js"></script>
