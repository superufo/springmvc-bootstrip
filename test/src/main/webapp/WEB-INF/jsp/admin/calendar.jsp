...
<head>
   <meta charset="utf-8" />
   <title>Metro风格响应式后台管理系统模板MetroAdmin 日历UI - JS代码网</title>
...
<body class="fixed-top">
          ...
          <div id="sidebar" class="nav-collapse collapse">
              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu active">
                      ...
                      <ul class="sub">
                          <li class="active"><a class="" href="calendar.jsp">Calendar</a></li>
   ...
   <script src="../static/win8/js/external-dragging-calendar.js"></script>
