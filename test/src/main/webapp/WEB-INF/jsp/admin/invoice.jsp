...
<head>
   <meta charset="utf-8" />
   <title>Metro风格响应式后台管理系统模板MetroAdmin 购物清单页面 - JS代码网</title>
              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu active">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a class="" href="invoice.jsp">Invoice</a></li>
            ...
            <div class="row-fluid">
                ...
                <div class="metro-nav">
                    ...
                    <div class="metro-nav-block  nav-block-grey">
                        <a href="invoice.jsp" data-original-title="">
                    ...
                    <div class="metro-nav-block nav-block-blue ">
                        <a href="create_invoice.jsp" data-original-title="">
                            <div class="text-center">
                                <i class="icon-edit"></i>
                            </div>
                    ...
                    <div class="metro-nav-block  nav-block-red">
                        <a href="invoice_list.jsp" data-original-title="">
                            <div class="text-center">
