...
<head>
   <meta charset="utf-8" />
   <title>Metro风格响应式后台管理系统模板MetroAdmin Font 拖拽组件特效 - JS代码网</title>
...
<body class="fixed-top">
              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu active">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a href="draggable_portlet.jsp" class="">Draggable Portlet</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a class="" href="javascript:;">
   ...
   <script src="../static/win8/js/draggable-portlet.js"></script>
