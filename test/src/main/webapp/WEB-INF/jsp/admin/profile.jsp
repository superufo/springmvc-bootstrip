...
<head>
   <meta charset="utf-8" />
   <title>Metro风格响应式后台管理系统模板MetroAdmin 用户资料页面 - JS代码网</title>
              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu active">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a class="" href="profile.jsp">Profile</a></li>
             ...
             <div class="row-fluid">
                 ...
                 <div class=" profile span12">
                     <div class="span2">
                         ...
                         <a href="profile.jsp" class="profile-features active">
                             <i class=" icon-user"></i>
                             <p class="info">Profile</p>
                         </a>
                         <a href="profile_activities.jsp" class="profile-features ">
                             <i class=" icon-calendar"></i>
                             <p class="info">Activities</p>
                         </a>
                         <a href="profile_contact.jsp" class="profile-features ">
                     ...
                     <div class="span10">
                         <div class="profile-head">
                             ...
                             <div class="span4">
                                 <a href="edit_profile.jsp" class="btn btn-edit btn-large pull-right mtop20"> Edit Profile </a>
                             </div>
                         </div>
