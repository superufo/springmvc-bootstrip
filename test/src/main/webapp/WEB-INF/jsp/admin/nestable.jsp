...
<head>
   <meta charset="utf-8" />
   <title>Metro风格响应式后台管理系统模板MetroAdmin 可嵌套列表- JS代码网</title>
   ...
   <link rel="stylesheet" type="text/css" href="../static/win8/assets/nestable/jquery.nestable.css" />
</head>
<!-- END HEAD -->
<!-- BEGIN BODY -->
<body class="fixed-top">
              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu active">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a class="" href="nestable.jsp">Nestable List</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
   ...
   <script src="../static/win8/assets/nestable/jquery.nestable.js"></script>
   ...
   <script src="../static/win8/js/nestable.js"></script>
