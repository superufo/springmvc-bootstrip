 ...
 * 自定义异常处理器
 */
public class AuthenticExceptionResolver implements HandlerExceptionResolver
{
    ...
    public ModelAndView resolveException(HttpServletRequest request,
        ...
        //异常信息
        String message=null;
        AuthenticException authenticException=null;
        //如果ex是系统自定义的异常，我们就直接取出异常信息
        if (ex instanceof AuthenticException)
        {
            authenticException= (AuthenticException) ex;
        }else {
            authenticException=new AuthenticException("未知错误");
        }

        //错误信息
        message=authenticException.getMessage();
