...
# Date: 2018-04-16 11:43:58
# Generator: MySQL-Front 5.3  (Build 4.234)

/*!40101 SET NAMES utf8 */;

#
# Structure for table "bom_table"
#

DROP TABLE IF EXISTS `bom_table`;
CREATE TABLE `bom_table` (
  `mt_code` char(10) NOT NULL,
  `mt_name` varchar(50) NOT NULL,
  `bom_level` int(4) NOT NULL,
  `quantity` int(10) NOT NULL,
  `um_code` char(10) NOT NULL,
  `um_name` varchar(50) NOT NULL,
  `pr_mt_code` char(10) DEFAULT NULL,
  `pr_mt_name` varchar(50) DEFAULT NULL,
  `src_mt_code` char(10) DEFAULT NULL,
  `child_count` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

#
# Data for table "bom_table"
#

INSERT INTO `bom_table` VALUES ('d54c692a','0x1213',1,30,'8a2f',' 吨','2ab396d4','111222','2ab396d4',0),('d54c692b','OX9000',1,300,'8a2f',' 吨','2ab396d4','111222','2ab396d4',1),('d54e','asddas',2,10,'8a2f',' 吨','d54c692b','111222','2ab396d4',0);

#
# Structure for table "cn_admin"
#
...
CREATE TABLE `cn_customer` (
  ...
  `scale` varchar(255) DEFAULT NULL COMMENT '规模 50人',
  `certno` varchar(30) DEFAULT NULL COMMENT '企业执照号码',
  `cert_img` varchar(4) NOT NULL COMMENT '类型 0 营业执照',
  `url` varchar(100) DEFAULT NULL COMMENT '企业网站',
  `weixin` varchar(200) DEFAULT NULL,
  `contact` varchar(100) DEFAULT NULL COMMENT '客户联系人名称',
  `contact_phone` varchar(30) DEFAULT NULL COMMENT '联系电话',
  `introduce` text,
  `keyin_user` varchar(100) DEFAULT NULL,
  `keyin_date` datetime DEFAULT NULL,
  PRIMARY KEY (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='客户（供货商）组织表';

#
# Data for table "cn_customer"
#

INSERT INTO `cn_customer` VALUES ('10000001','国企','中国航天信息科技','中航信','广东','广州','天河区',NULL,'52','1000-5000','52122211MA214','52',NULL,NULL,NULL,NULL,NULL,NULL,NULL),('100a002b','国企','贵州三维监理','三维监理','贵州','毕节','金沙县',NULL,'56','1000-5000','52122211MA54','56',NULL,NULL,NULL,NULL,NULL,NULL,NULL),('100a0035','国企','贵州三维监理','三维监理','贵州','贵阳','南明区','黄科101号','58','1000-5000','52122211MA214','58',NULL,NULL,NULL,NULL,NULL,NULL,NULL),('100a0041','国企','贵州三维监理','三维监理','贵州','贵阳','南明区','黄科101号','63','500-1000','52122211MA54','63','www.baidu.com','18680254123','张娜','18680254123','<ul><li>ssssssssssss</li></ul>﻿<br><br><ul><li>xcvxcvcxcvvcx</li></ul>','','2017-11-09 17:31:11'),('100a004b','外资','东莞富士康科技有限公司','富士康',NULL,'东莞','万江区','豪程广场A栋','66','10000','52122211MA985','66','http://www.fsk.com','18882220022','黄生','18882220022','<div>富智康精密组件（北京）有限公司位于位于北京经济技术开发区（BDA）同济中路18号，占地500亩。2001年一期投产，2006年二期投产，2008年三期投产，一期、二期之间有富士康桥相连，与三期相距2公里﹐北富现共有员工3000余人。北京厂区未来定位：商贸中心、育成中心、研发中心、检测中心、模具中心。<br><img src=\"http://www.backend.cn/uploads\\20171110\\4c83ef87d785f5ce40e4623cc508933c.jpg\" title=\"Image: http://www.backend.cn/uploads\\20171110\\4c83ef87d785f5ce40e4623cc508933c.jpg\"><br><br><br></div><div><div><a target=\"_blank\" rel=\"nofollow\"></a></div></div>',NULL,'2017-11-10 12:55:41'),('100a0055','国企','中兴通讯','中兴通讯','广东','深圳','福田区','豪程广场A栋','72','5000-10000','52122211MA214',' ','','18920201010','张生','18920201010','<div>关于我们<ul><li><a target=\"_blank\" rel=\"nofollow\" href=\"http://www.zte.com.cn/china/about/corporate_information\">公司介绍</a></li><li><a target=\"_blank\" rel=\"nofollow\" href=\"http://www.zte.com.cn/china/about/Corporate-Culture\">企业文化</a></li><li><a target=\"_blank\" rel=\"nofollow\" href=\"http://www.zte.com.cn/china/about/investorrelations\">投资者关系</a></li><li><a target=\"_blank\" rel=\"nofollow\" href=\"http://www.zte.com.cn/china/about/citizenship\">社会责任</a></li><li><a target=\"_blank\" rel=\"nofollow\" href=\"http://www.zte.com.cn/china/about/global-sales-offices\">全球销售网点</a></li><li><a target=\"_blank\" rel=\"nofollow\" href=\"http://www.zte.com.cn/china/about/contact-us\">联系我们</a></li><li><a target=\"_blank\" rel=\"nofollow\" href=\"http://www.zte.com.cn/china/about/publications\">公司期刊</a></li></ul></div><div>公司介绍<div></div><a target=\"_blank\" rel=\"nofollow\" href=\"http://www.zte.com.cn/china/about/corporate_information/Introduction\">公司简介</a><div>中兴通讯是全球领先的综合通信解决方案提供商。公司成立于1985年，是在香港和深圳两地上市的大型通讯设备公司。公司通过为全球160多个国家和地区的电信运营商和企业网客户提供创新技术与产品解决方案，让全世界用户享有语音、数据、多媒体、无线宽带等全方位沟通。</div><a target=\"_blank\" rel=\"nofollow\">＋打开</a><ul><li><img width=\"474\" alt=\"\" src=\"http://res.www.zte.com.cn/mediares/zte/Global/about/W020140821533047060152.jpg?h=270&amp;la=zh-CN&amp;w=474\" height=\"270\" title=\"Image: http://res.www.zte.com.cn/mediares/zte/Global/about/W020140821533047060152.jpg?h=270&amp;la=zh-CN&amp;w=474\"><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://www.zte.com.cn/china/about/corporate_information/vision\">使命与愿景</a><span>企业愿景：成为M-ICT时代的领导者。<br>企业使命：我们致力于为合作伙伴构筑安全、开放、共享的平台，为用户带来更酷、更绿色、更开放的ICT产品和服务。</span><a target=\"_blank\" rel=\"nofollow\" href=\"http://www.zte.com.cn/china/about/corporate_information/vision\">详细　&gt;</a></div></li><li><img width=\"320\" alt=\"\" src=\"http://res.www.zte.com.cn/mediares/zte/Global/about/W020121031573039743788.jpg?h=132&amp;la=zh-CN&amp;w=320\" height=\"132\"><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://www.zte.com.cn/china/about/corporate_information/product_business\">产品领域</a>中兴通讯的产品涵盖无线、核心网、接入、承载、业务、终端、云计算、服务等领域。<a target=\"_blank\" rel=\"nofollow\" href=\"http://www.zte.com.cn/china/about/corporate_information/product_business\">详细　&gt;</a></div></li></ul></div>',NULL,'2017-11-10 15:39:45');

#
# Structure for table "cn_customer_type"
#

DROP TABLE IF EXISTS `cn_customer_type`;
CREATE TABLE `cn_customer_type` (
  `struct_type` char(2) NOT NULL COMMENT '组织类型',
  `struct_type_desc` varchar(100) NOT NULL COMMENT '组织类型描述',
  `remark` varchar(1000) DEFAULT NULL,
  `keyin_user` varchar(100) NOT NULL,
  `keyin_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`struct_type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='组织类型表  计划合并到ym_erp_setting';

#
# Data for table "cn_customer_type"
#

INSERT INTO `cn_customer_type` VALUES ('09','总公司','','peter','2016-12-14 15:47:17'),('a9','总公司','','peter','2016-12-14 15:50:58');

#
# Structure for table "cn_department"
#

DROP TABLE IF EXISTS `cn_department`;
CREATE TABLE `cn_department` (
  `department_code` char(8) NOT NULL COMMENT '部门代码',
  `department_name` varchar(40) NOT NULL COMMENT '部门名称',
  `struct_code` char(6) NOT NULL COMMENT '组织代码',
  `status` tinyint(4) NOT NULL COMMENT '0 启用 1 关闭',
  `user_id` varchar(100) DEFAULT NULL COMMENT '部门主管 关联user_id',
...
#
# Data for table "cn_department"
#

INSERT INTO `cn_department` VALUES ('a0000002','销售','5cd445',0,'21','1232-2332','','peter','2017-01-11 04:09:32');

#
# Structure for table "cn_file"
#

DROP TABLE IF EXISTS `cn_file`;
...
CREATE TABLE `cn_post` (
  `code` char(8) NOT NULL COMMENT '岗位代码',
  `name` varchar(100) NOT NULL COMMENT '岗位名称',
  `fulljob` varchar(255) DEFAULT NULL COMMENT '兼职 全职',
  `description` varchar(1000) DEFAULT NULL,
  `customer_code` varchar(255) NOT NULL,
  `customer_name` varchar(255) NOT NULL,
  `department_code` char(8) DEFAULT NULL COMMENT '部门代码',
  `department_name` varchar(255) DEFAULT NULL,
  `start_date` date DEFAULT NULL,
  `end_date` date DEFAULT NULL,
  `enabled` tinyint(4) DEFAULT NULL COMMENT '0 启用 1 关闭',
  `status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0 启用 1 关闭',
  `need_num` varchar(11) DEFAULT NULL COMMENT '招聘人数',
  `handle_num` int(11) DEFAULT NULL COMMENT '投递人数',
  `finish_num` int(11) DEFAULT NULL,
  `request` text COMMENT '工作人员要求',
  `duty` text NOT NULL COMMENT '职责',
  `province` varchar(255) DEFAULT NULL COMMENT '工作省份',
  `city` varchar(255) DEFAULT NULL,
  `town` varchar(255) DEFAULT NULL,
  `street` varchar(255) DEFAULT NULL COMMENT '详细地址',
  `min_money` int(11) DEFAULT '0' COMMENT '工资范畴',
  `max_money` int(11) DEFAULT '0' COMMENT '工资范畴',
  `work_year` int(2) DEFAULT '0' COMMENT '工作经验',
  `education` varchar(4) DEFAULT NULL COMMENT '学历',
  `mode` varchar(255) DEFAULT NULL COMMENT 'it类  工厂类',
  `keyin_date` datetime DEFAULT '0000-00-00 00:00:00',
  `keyin_user` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='岗位表';

#
# Data for table "cn_post"
#

INSERT INTO `cn_post` VALUES ('10000000','java开发','全职',NULL,'10000001','中国航天信息科技','','',NULL,NULL,0,0,'120',NULL,NULL,'<ol><li>sssss</li><li>gdfgfdg</li><li>dsfdsf</li></ol>','<ol><li>sssss</li><li>gdfgfdg</li><li>dsfdsf</li></ol>','广东','广州','天河区','黄科１０１号',10000,15000,4,'其他','IT行业','2017-11-10 11:34:35',NULL),('1000000a','架构师','全职',NULL,'10000001','中国航天信息科技','','',NULL,NULL,0,0,'20',NULL,NULL,'1、负责公司大数据平台搭建、功能设计、及核心模块的开发；<br>2、对现有大数据架构进行分析，给出优化方案并带领技术人员共同完成实施，参与公司内外部大数据项目需求分析及数据建模、方案评估;<br>3、负责公司大数据平台运维、优化、改造；<br>4、进行数据仓库持续建设及实施；','1、5年以上开发经验，熟练运用Java、Scala、C++、Python语言中的一种；<br>2、熟练掌握linux常规命令与工具，Python，shell，至少熟悉其中一种<br>3、深入理解分布式数据分析挖掘平台相关技术框架，能够根据业务需求，提出数据平台选型建议并完成相关架构设计带领技术人员迅速搭建系统；<br>4、具有商业敏感度；深入理解数据存储，分析处理过程和业务场景；具备非结构化数据到结构化数据转换中所需要的经验和技术积累；<br>5、熟练掌握Hadoop、Hive、Hbase、spark等分布式框架原理，有相关的调优、运维、开发经验；6、熟练使用Hadoop / Spark进行开发，熟悉hadoop/Spark平台运维及ELK框架7、在高并发处理、调优等方面有经验更佳，参与过数据量达pb级数据项目更佳；','广东','广州','天河区','都市广场１５楼',40000,55000,10,'研究生','IT行业','2017-11-10 12:48:45',NULL),('10000014','java中级开发','全职',NULL,'10000001','中国航天信息科技','','',NULL,NULL,0,0,'80',NULL,NULL,'<ul><li>人靠谱，有责任心和团队协作精神</li><li>对技术有热情，学习能力强，在某个技术领域有自己的见解</li><li>有代码洁癖</li></ul>','<ol><li>具有扎实的Java基础，逻辑思维缜密；</li><li>熟练使用RPC框架，具备相关的分布式开发经验；</li><li>具备TCP方面的网络编程经验；</li><li>具备WEB方面的开发经验；</li><li>熟练使用Mybatis，SpringMVC，SpringCloud等框架。</li></ol>','广东','广州','天河区','都市广场１５楼',8000,20000,4,'无要求','IT行业','2017-11-10 12:50:40',NULL),('1000001e','操作工人','全职',NULL,'100a004b','东莞富士康科技有限公司','','',NULL,NULL,0,0,'1000',NULL,NULL,'<div>工作时间：</div><div>两班倒</div><div><div>每天工作10～12小时<br></div><div>实行做六休一工作制，月休3-4天</div></div><div><br></div>','主要生产手机配件产品 分拣，组装，扫描，贴商标等.轻松简单，管理人性化等简单 易懂工作','广东','东莞','万江区','豪程广场A栋',2000,7000,1,'无要求','工厂','2017-11-10 13:01:27',NULL),('10000028','车工','全职',NULL,'100a004b','东莞富士康科技有限公司','','',NULL,NULL,0,0,'1200',NULL,NULL,'1、男性，20-45岁，能够看懂加工零件图纸；<br>2、三年以上普通车床的独立操机的加工工作经验；<br>3、熟悉机器的日常保养；<br>4、吃苦耐劳，有安全生产意识，服从领导合理安排；','1、负责按照工艺文件和图纸加工机械五金零部件；<br>2、严格按照机床操作规程和机床使用说明书的要求使用机床；<br>3、负责机床的日常清洁维护保养；','广东','东莞','万江区','豪程广场A栋',2000,10000,1,'无要求','工厂','2017-11-10 13:03:38',NULL),('10000032','电焊工','全职',NULL,'100a004b','东莞富士康科技有限公司','','',NULL,NULL,0,0,'100',NULL,NULL,'1、技工需机械类专业中专以上学历，40周岁以下；<br>2、持有电工上岗证、高压证等工程类资格证；<br>3、实习生18周岁以上，中专以上学历，须持电工上岗证；<br>4、有意向往物业工程方向发展者优先；<br>5、个人职业发展规划，可以往工程领班、工程主任、项目经理、区域总监方向发展。','1、负责辖区内各项工程设施设备的正常运行、维护、定期保养。<br>2、协助负责所管辖小区配电室、楼层配电箱、住户照明、电气等设备的日常管理和维修工作<br>3、保证电气设备的安全运行；<br>4、协助小区公共设施的维修保养。','广东','东莞','万江区','豪程广场A栋',2000,8000,1,'高中','工厂','2017-11-10 13:06:02',NULL),('1000003c','架构师','全职',NULL,'100a0055','中兴通讯','','',NULL,NULL,0,0,'20',NULL,NULL,'1、5年以上开发经验，熟练运用Java、Scala、C++、Python语言中的一种；&lt;br&gt;2、熟练掌握linux常规命令与工具，Python，shell，至少熟悉其中一种&lt;br&gt;3、深入理解分布式数据分析挖掘平台相关技术框架，能够根据业务需求，提出数据平台选型建议并完成相关架构设计带领技术人员迅速搭建系统；&lt;br&gt;4、具有商业敏感度；深入理解数据存储，分析处理过程和业务场景；具备非结构化数据到结构化数据转换中所需要的经验和技术积累；&lt;br&gt;5、熟练掌握Hadoop、Hive、Hbase、spark等分布式框架原理，有相关的调优、运维、开发经验；6、熟练使用Hadoop / Spark进行开发，熟悉hadoop/Spark平台运维及ELK框架7、在高并发处理、调优等方面有经验更佳，参与过数据量达pb级数据项目更佳；','1、负责公司大数据平台搭建、功能设计、及核心模块的开发；&lt;br&gt;2、对现有大数据架构进行分析，给出优化方案并带领技术人员共同完成实施，参与公司内外部大数据项目需求分析及数据建模、方案评估;&lt;br&gt;3、负责公司大数据平台运维、优化、改造；&lt;br&gt;4、进行数据仓库持续建设及实施；','广东','深圳','罗湖区','豪程广场A栋',8000,15000,4,'专科','IT行业','2017-11-11 10:58:27',NULL);

#
# Structure for table "cn_post_resume"
#

DROP TABLE IF EXISTS `cn_post_resume`;
CREATE TABLE `cn_post_resume` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
#
# Data for table "cn_post_resume"
#

INSERT INTO `cn_post_resume` VALUES (1,10000008,'1000003c','架构师','ab77611314db87d981e2','2017-11-16 01:33:32'),(2,10000008,'1000003c','架构师','ab77611314db87d981e2','2017-11-16 01:34:20'),(3,10000008,'10000000','java开发','ab77611314db87d981e2','2017-11-16 09:47:42'),(4,10000008,'10000014','java中级开发','ab77611314db87d981e2','2017-11-16 11:08:48');

#
# Structure for table "cn_resume"
#

DROP TABLE IF EXISTS `cn_resume`;
CREATE TABLE `cn_resume` (
  `code` varchar(8) DEFAULT NULL,
  `openid` varchar(60) DEFAULT NULL,
  `education_experince` text COMMENT '教育经历',
  `work_experince` text COMMENT '工作经历',
  `project_experince` text,
  `skill` text,
  `job` varchar(255) DEFAULT NULL COMMENT '期望职位',
  `city` varchar(255) DEFAULT NULL COMMENT '期望城市',
  `sarary` varchar(255) DEFAULT NULL COMMENT '期望月薪',
  `fulljob` varchar(255) DEFAULT NULL COMMENT '全职'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

#
# Data for table "cn_resume"
#

INSERT INTO `cn_resume` VALUES ('10000006','ab77611314db87d981e2','贵州大学\n大专 · 房屋建筑\n2003年毕业','中建四局\n施工员\n\n2005.07 — 2008.07\n中建四局智慧龙城B3-5项目部 。 \n1>   负责建筑工地现场人员安排,班组调配。 \n2>   预算,材料进场，材料复检，见证取样,质量检查等。 \n3>   质量计划，进度控制，成本控制，质量控制。 \n参与基础，主体竣工验收,工程变更，施工图绘制，进度计划安排及绘制等各项工程活动。','建设银行大型电子商城系统 mall.ccb.com\n高级php开发\n\n2011.07 - 2013.08\n项目描述 建设银行推出的类似阿里巴巴网购的b2b平台 \n责任描述 1.主要负责对应后端的php表现层页面的开发；2 负责后端java app包括有企业空间，物流系统等开发；3．负责sphinx搜索引擎的架构，和基于https协议之上的CA安全认证系统配置与架构,i18n 国际化架构,php扩展编程（使用c做底层的php的扩展）4.负责部分的web php性能优化等!','php java android shell. react redux  mysql db2 axsure  sip协议 http协议 项目中mule esb开发经验','程序员','广州','52000','无要求'),('10000008','ab77611314db87d981e2','贵州大学\n大专 · 房屋建筑\n2003年毕业','中建四局\n施工员\n2005.07 — 2008.07\n中建四局智慧龙城B3-5项目部 。 \n1>   负责建筑工地现场人员安排,班组调配。 \n2>   预算,材料进场，材料复检，见证取样,质量检查等。 \n3>   质量计划，进度控制，成本控制，质量控制。 \n参与基础，主体竣工验收,工程变更，施工图绘制，进度计划安排及绘制等各项工程活动。','广东移动经营分析系统-统一运营支撑系统\njava开发 维护\n\n2010.01 - 2011.07\n项目描述 基于数据仓库架构上的应用项目! 通过系统对广东移动的数据质量的管理和监控。包括接口，作业，指标，设备，数据库的管理和监控。包括广东21地市和7多个数据仓库集市的数据。实现了数据的实时和精准的控制! \n责任描述 负责作业和接口编码和后台数据库及shell的处理。使用技术；AIX +JAVA+DB2+EXTJS+SHELL .','php java android shell. react redux  mysql db2 axsure  sip协议 http协议 项目中mule esb开发经验','总监','广州','50000','无要求'),('1000000a','ab77611314db87d981e2','if (res.data.data.resumeId !== \'\' || res.data.data.resumeId !== null ){\n            //简历新增页面\n            wx.redirectTo({\n              url: \'../resume/add?openid=\' + userInfo.openid + \'&post_code=\' + that.data.position.data.code\n            })\n          }','if (res.data.data.resumeId !== \'\' || res.data.data.resumeId !== null ){\n            //简历新增页面\n            wx.redirectTo({\n              url: \'../resume/add?openid=\' + userInfo.openid + \'&post_code=\' + that.data.position.data.code\n            })\n          }','if (res.data.data.resumeId !== \'\' || res.data.data.resumeId !== null ){\n            //简历新增页面\n            wx.redirectTo({\n              url: \'../resume/add?openid=\' + userInfo.openid + \'&post_code=\' + that.data.position.data.code\n            })\n          }','if (res.data.data.resumeId !== \'\' || res.data.data.resumeId !== null ){\n            //简历新增页面\n            wx.redirectTo({\n              url: \'../resume/add?openid=\' + userInfo.openid + \'&post_code=\' + that.data.position.data.code\n            })\n          }','工程师','深圳','100000','无要求');

#
# Structure for table "cn_role"
#
...
DROP TABLE IF EXISTS `cn_struct`;
CREATE TABLE `cn_struct` (
  `struct_code` char(6) NOT NULL COMMENT '组织代码',
  `struct_name` varchar(100) NOT NULL COMMENT '组织名称',
  `short_name` varchar(100) DEFAULT NULL COMMENT '简称',
  `struct_type` char(2) NOT NULL,
  `status` tinyint(4) DEFAULT NULL COMMENT '0 启用 1 关闭',
  ...
  KEY `fk_struct_type` (`struct_type`),
  CONSTRAINT `fk_struct_type` FOREIGN KEY (`struct_type`) REFERENCES `cn_customer_type` (`struct_type`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

#
# Data for table "cn_struct"
#

INSERT INTO `cn_struct` VALUES ('22bf1d','222','测试02','a9',0,'gai','阿姆斯特丹','15923302','1232-2332','123@qq.com','321','peter','2016-12-16 04:01:35'),('4fc113','1111','测试01','09',1,'gai','阿姆斯特丹','15923302','1232-2332','123@qq.com','','peter','2016-12-16 03:51:45'),('5cd445','阿尔盖特1','测试03','a9',1,'gai','阿姆斯特丹','15923302','1232-2332','123@qq.com','111111','peter','2016-12-16 04:02:51'),('bfdea0','总公司','总公司','09',1,'zgs','江门市大泽','1888888888','07508888888','8888888@xx.com','','peter','2016-12-14 15:57:42');

#
# Structure for table "cn_topic"
#

DROP TABLE IF EXISTS `cn_topic`;
CREATE TABLE `cn_topic` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tab` int(10) NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
  `info` text NOT NULL,
  `img` int(11) DEFAULT '0',
  `img_url` varchar(300) DEFAULT '''''',
  `vidio` int(11) DEFAULT NULL,
  `vidio_url` varchar(300) DEFAULT NULL,
  `topic_label` json DEFAULT NULL,
  `openid` varchar(200) DEFAULT NULL,
  `like` int(11) DEFAULT '0',
  `comment_count` int(11) DEFAULT '0',
  `commnet_ids` json DEFAULT NULL COMMENT '评论id',
  `op_user` varchar(200) DEFAULT NULL,
  `op_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8;

#
# Data for table "cn_topic"
#

INSERT INTO `cn_topic` VALUES (1,1,'Mule 官方例子研究','<ol><li>求助：</li></ol><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://bbs.reactnative.cn/category/4/%E6%B1%82%E5%8A%A9%E4%B8%93%E5%8C%BA\">http://bbs.reactnative.cn/category/4/求助专区</a></div><div><br></div><div><br></div><ol><li>运行踩坑记</li></ol><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://www.jianshu.com/p/22aa14664cf9?open_source=weibo_search\">http://www.jianshu.com/p/22aa14664cf9?open_source=weibo_search</a></div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://localhost:8081/debugger-ui\">http://localhost:8081/debugger-ui</a></div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://localhost:8081/index.android.bundle?platform=android\">http://localhost:8081/index.android.bundle?platform=android</a></div><div><br></div><div>进入项目，在android/app/src/main下新建assets目录</div><div>在package.json中配置下面代码</div><div>\"scripts\":{</div><div>\"start\": \"node node_modules/react-native/local-cli/cli.js start\",</div><div>\"bundle-android\": \"react-native bundle --platform android --dev false --entry-file index.android.js --bundle-output app/src/main/assets/index.android.bundle --sourcemap-output app/src/main/assets/index.android.map --assets-dest android/app/src/main/res/\"</div><div>},</div><div><br></div><ol><li>安装踩坑</li></ol><div>MSBUILD : error MSB3428: 未能加载 Visual C++ 组件“VCBuild.exe”。要解决此问题，1) 安装 .NET Framework 2.0 SDK；2) 安装 Microsoft Visual Studio 2005；或 3) 如果将该组件安装到了其他位置，请将其位置添加到系统路径中。 [D:\\react-native-pro\\f8app-master\\f8app-master\\node_modules\\bufferutil\\build\\binding.sln]</div><div><br></div><div>参考 ：<a target=\"_blank\" rel=\"nofollow\" href=\"http://www.w2bc.com/article/103350\">http://www.w2bc.com/article/103350</a></div><ul><li>Python 2.7下载地址 &nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://www.python.org/downloads/\">https://www.python.org/downloads/</a>&nbsp;&nbsp;</li></ul><div>git &nbsp; 安装React-native需要用到git下载地址：<a target=\"_blank\" rel=\"nofollow\" href=\"https://git-for-windows.github.io/\">https://git-for-windows.github.io/</a></div><div>nodejs v5.7.0 Stable 下载网站&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://nodejs.org/en/\">https://nodejs.org/en/</a>&nbsp;&nbsp; &nbsp;</div><ul><li>react-native命令行从npm官方源拖代码时会遇上麻烦。请将npm仓库源替换为国内镜像：</li></ul><div>npm config set registry&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://registry.npm.taobao.org/\">https://registry.npm.taobao.org</a>&nbsp;npm config set disturl&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://npm.taobao.org/dist\">https://npm.taobao.org/dist</a></div><ul><li>&nbsp;npm install -g react-native-cli</li></ul><ul><li>命令行进入你希望创建项目的目录输入 &nbsp;react-native init AwesomeProject react-native start</li></ul><div><br></div><ol><li>错误：</li></ol><div>at Object.&lt;anonymous&gt; (D:\\react-native-pro\\learning-react-native-master\\WeatherProject\\node_modules\\react-native\\packager\\babelRegisterOnly.js:11:27)</div><div>先npm install 则如下：</div><div>rm -rf node_modules</div><div>npm install</div><div><br></div><div><br></div><ol><li>genymotion win10 踩坑</li></ol><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://blog.csdn.net/zhan1350441670/article/details/47975341\">http://blog.csdn.net/zhan1350441670/article/details/47975341</a></div><div>C:\\Users\\Administrator\\AppData\\Local</div><div>C:\\Users\\Administrator\\AppData\\Roaming</div><div>C:\\Users\\Administrator\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs</div><div>C:\\Users\\Administrator\\.bundle\\cache\\compact_index\\rubygems.org.443.29b0360b937aa4d161703e6160654e47\\info</div><div>C:/Users/Administrator/AppData/Local/Genymobile/</div><div>删除里面 virtualbox 文件，以及“硬件管理”删除多余网络链接，重新安装，</div><div>virtualbox 为4.点多 ，Genymobile 2.6 2.53 可以运行。</div><div><br></div><ol><li>运行踩坑记</li></ol><div>真机白屏</div><div>1.把应用的悬浮框权限开启</div><div>2.在手机上设置local ip和端口地址，才可以把js等资源下载到手机上进行调试。</div><div>react evaluating \'babelHelpers.typeof(global))</div><div><br></div><div><br></div><div>新版本babel，拆分成babel-cli和babel-core，你2个都要install。</div><div>babel 踩坑&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"http://www.imooc.com/article/11157\">http://www.imooc.com/article/11157</a></div><div><br></div><div>babel 编译插件</div><div>npm install babel-plugin-transform-react-jsx</div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://blog.csdn.net/github_26672553/article/details/52026687\">reactJS - 03利用babel来”编译”我们的脚本文件</a></div><div><br></div><div><br></div><div>react+webpack+babel才可以使用ES6&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://segmentfault.com/q/1010000003835383\">https://segmentfault.com/q/1010000003835383</a></div><div><br></div><ol><li>运行踩坑记</li></ol><div>Error:Error: File path too long on Windows, keep below 240 characters</div><div>在跟目录下的gradle.build 添加如下 allprojects { repositories { jcenter() mavenLocal() } buildDir = \"C:/tmp/${rootProject.name}/${project.name}\" }</div><div><br></div><ol><li>运行踩坑记</li></ol><div><br></div><div><br></div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://stackoverflow.com/questions/35050991/react-native-android-assembledebug-log-unknown-source-file-warning-string-c\" title=\"Link: http://stackoverflow.com/questions/35050991/react-native-android-assembledebug-log-unknown-source-file-warning-string-c\">Unknown source file : warning: string \'catalyst_debugjs\' has no default translation</a></div><div>&nbsp;in&nbsp;build.gradle&nbsp;file.</div><div>Change</div><div>classpath \'com.android.tools.build:gradle:1.3.1\'</div><div>To</div><div>classpath \'com.android.tools.build:gradle:1.5.0\'</div><div><br></div><div><br></div><div><br></div><ol><li>运行踩坑记</li></ol><div>babelHelpers.typeof is not a function</div><div><br></div><div><br></div><div><br></div><ol><li>运行踩坑记</li></ol><div><br></div><div><br></div><div>npm install node-pre-gyp -g</div><div>npm uninstall -g watchman</div><div><br></div><div>Watchman: Watchman was not found in PATH. See&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://facebook.github.io/watchman/docs/install.html\">https://facebook.github.io/watchman/docs/install.html</a>&nbsp;for installation instructions</div><div>uninstall -g watchman</div><div><br></div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://www.cnblogs.com/agilee/p/5096974.html\" title=\"Link: http://www.cnblogs.com/agilee/p/5096974.html\">http://www.cnblogs.com/agilee/p/5096974.html</a></div><div>如果你下载的是最新版本，那么请安装cygwin，然后切换到node_modules\\react-native\\packager，然后运行：</div><div>./packager.sh --nonPersistent</div><div>注意一定要加--nonPersistent参数，否则会因为加载watchman而失败</div><div><br></div><div><br></div><div><br></div><div><br></div><ol><li>运行踩坑记</li></ol><div><br></div><div>ReactAndroid:buildReactNdkLib FAILED</div><div>原因为NDK 版本不对，必须gcc4.8，请选择&nbsp;Android NDK r10e&nbsp;对应系统下载安装</div><div><br></div><div><br></div><ol><li>运行踩坑记</li><li>运行踩坑记</li><li>运行踩坑记</li><li>运行踩坑记</li></ol><div><br></div><div><br></div><div>/app/data/quzhen/wp-content/themes/markbrick/functions.php</div><div>/app/data/quzhen/wp-content/themes/markbrick-----</div><div>/app/data/quzhen/wp-content/themes/markbrick</div>',0,'',0,'http://tb-video.bdstatic.com/tieba-smallvideo-transcode/10_51d807011d62fd941e90bcbfec3a4fdd_2.mp4',X'5B2220225D','ab77611314db87d981e2',NULL,0,NULL,NULL,'2017-11-18 17:14:36'),(2,2,'Mule 官方例子研究','<ol><li>求助：</li></ol><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://bbs.reactnative.cn/category/4/%E6%B1%82%E5%8A%A9%E4%B8%93%E5%8C%BA\">http://bbs.reactnative.cn/category/4/求助专区</a></div><div><br></div><div><br></div><ol><li>运行踩坑记</li></ol><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://www.jianshu.com/p/22aa14664cf9?open_source=weibo_search\">http://www.jianshu.com/p/22aa14664cf9?open_source=weibo_search</a></div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://localhost:8081/debugger-ui\">http://localhost:8081/debugger-ui</a></div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://localhost:8081/index.android.bundle?platform=android\">http://localhost:8081/index.android.bundle?platform=android</a></div><div><br></div><div>进入项目，在android/app/src/main下新建assets目录</div><div>在package.json中配置下面代码</div><div>\"scripts\":{</div><div>\"start\": \"node node_modules/react-native/local-cli/cli.js start\",</div><div>\"bundle-android\": \"react-native bundle --platform android --dev false --entry-file index.android.js --bundle-output app/src/main/assets/index.android.bundle --sourcemap-output app/src/main/assets/index.android.map --assets-dest android/app/src/main/res/\"</div><div>},</div><div><br></div><ol><li>安装踩坑</li></ol><div>MSBUILD : error MSB3428: 未能加载 Visual C++ 组件“VCBuild.exe”。要解决此问题，1) 安装 .NET Framework 2.0 SDK；2) 安装 Microsoft Visual Studio 2005；或 3) 如果将该组件安装到了其他位置，请将其位置添加到系统路径中。 [D:\\react-native-pro\\f8app-master\\f8app-master\\node_modules\\bufferutil\\build\\binding.sln]</div><div><br></div><div>参考 ：<a target=\"_blank\" rel=\"nofollow\" href=\"http://www.w2bc.com/article/103350\">http://www.w2bc.com/article/103350</a></div><ul><li>Python 2.7下载地址 &nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://www.python.org/downloads/\">https://www.python.org/downloads/</a>&nbsp;&nbsp;</li></ul><div>git &nbsp; 安装React-native需要用到git下载地址：<a target=\"_blank\" rel=\"nofollow\" href=\"https://git-for-windows.github.io/\">https://git-for-windows.github.io/</a></div><div>nodejs v5.7.0 Stable 下载网站&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://nodejs.org/en/\">https://nodejs.org/en/</a>&nbsp;&nbsp; &nbsp;</div><ul><li>react-native命令行从npm官方源拖代码时会遇上麻烦。请将npm仓库源替换为国内镜像：</li></ul><div>npm config set registry&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://registry.npm.taobao.org/\">https://registry.npm.taobao.org</a>&nbsp;npm config set disturl&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://npm.taobao.org/dist\">https://npm.taobao.org/dist</a></div><ul><li>&nbsp;npm install -g react-native-cli</li></ul><ul><li>命令行进入你希望创建项目的目录输入 &nbsp;react-native init AwesomeProject react-native start</li></ul><div><br></div><ol><li>错误：</li></ol><div>at Object.&lt;anonymous&gt; (D:\\react-native-pro\\learning-react-native-master\\WeatherProject\\node_modules\\react-native\\packager\\babelRegisterOnly.js:11:27)</div><div>先npm install 则如下：</div><div>rm -rf node_modules</div><div>npm install</div><div><br></div><div><br></div><ol><li>genymotion win10 踩坑</li></ol><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://blog.csdn.net/zhan1350441670/article/details/47975341\">http://blog.csdn.net/zhan1350441670/article/details/47975341</a></div><div>C:\\Users\\Administrator\\AppData\\Local</div><div>C:\\Users\\Administrator\\AppData\\Roaming</div><div>C:\\Users\\Administrator\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs</div><div>C:\\Users\\Administrator\\.bundle\\cache\\compact_index\\rubygems.org.443.29b0360b937aa4d161703e6160654e47\\info</div><div>C:/Users/Administrator/AppData/Local/Genymobile/</div><div>删除里面 virtualbox 文件，以及“硬件管理”删除多余网络链接，重新安装，</div><div>virtualbox 为4.点多 ，Genymobile 2.6 2.53 可以运行。</div><div><br></div><ol><li>运行踩坑记</li></ol><div>真机白屏</div><div>1.把应用的悬浮框权限开启</div><div>2.在手机上设置local ip和端口地址，才可以把js等资源下载到手机上进行调试。</div><div>react evaluating \'babelHelpers.typeof(global))</div><div><br></div><div><br></div><div>新版本babel，拆分成babel-cli和babel-core，你2个都要install。</div><div>babel 踩坑&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"http://www.imooc.com/article/11157\">http://www.imooc.com/article/11157</a></div><div><br></div><div>babel 编译插件</div><div>npm install babel-plugin-transform-react-jsx</div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://blog.csdn.net/github_26672553/article/details/52026687\">reactJS - 03利用babel来”编译”我们的脚本文件</a></div><div><br></div><div><br></div><div>react+webpack+babel才可以使用ES6&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://segmentfault.com/q/1010000003835383\">https://segmentfault.com/q/1010000003835383</a></div><div><br></div><ol><li>运行踩坑记</li></ol><div>Error:Error: File path too long on Windows, keep below 240 characters</div><div>在跟目录下的gradle.build 添加如下 allprojects { repositories { jcenter() mavenLocal() } buildDir = \"C:/tmp/${rootProject.name}/${project.name}\" }</div><div><br></div><ol><li>运行踩坑记</li></ol><div><br></div><div><br></div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://stackoverflow.com/questions/35050991/react-native-android-assembledebug-log-unknown-source-file-warning-string-c\">Unknown source file : warning: string \'catalyst_debugjs\' has no default translation</a></div><div>&nbsp;in&nbsp;build.gradle&nbsp;file.</div><div>Change</div><div>classpath \'com.android.tools.build:gradle:1.3.1\'</div><div>To</div><div>classpath \'com.android.tools.build:gradle:1.5.0\'</div><div><br></div><div><br></div><div><br></div><ol><li>运行踩坑记</li></ol><div>babelHelpers.typeof is not a function</div><div><br></div><div><br></div><div><br></div><ol><li>运行踩坑记</li></ol><div><br></div><div><br></div><div>npm install node-pre-gyp -g</div><div>npm uninstall -g watchman</div><div><br></div><div>Watchman: Watchman was not found in PATH. See&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://facebook.github.io/watchman/docs/install.html\">https://facebook.github.io/watchman/docs/install.html</a>&nbsp;for installation instructions</div><div>uninstall -g watchman</div><div><br></div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://www.cnblogs.com/agilee/p/5096974.html\">http://www.cnblogs.com/agilee/p/5096974.html</a></div><div>如果你下载的是最新版本，那么请安装cygwin，然后切换到node_modules\\react-native\\packager，然后运行：</div><div>./packager.sh --nonPersistent</div><div>注意一定要加--nonPersistent参数，否则会因为加载watchman而失败</div><div><br></div><div><br></div><div><br></div><div><br></div><ol><li>运行踩坑记</li></ol><div><br></div><div>ReactAndroid:buildReactNdkLib FAILED</div><div>原因为NDK 版本不对，必须gcc4.8，请选择&nbsp;Android NDK r10e&nbsp;对应系统下载安装</div><div><br></div><div><br></div><ol><li>运行踩坑记</li><li>运行踩坑记</li><li>运行踩坑记</li><li>运行踩坑记</li></ol><div><br></div><div><br></div><div>/app/data/quzhen/wp-content/themes/markbrick/functions.php</div><div>/app/data/quzhen/wp-content/themes/markbrick-----</div><div>/app/data/quzhen/wp-content/themes/markbrick</div>',0,'',0,'http://tb-video.bdstatic.com/tieba-smallvideo-transcode/10_51d807011d62fd941e90bcbfec3a4fdd_2.mp4',X'5B2220225D','ab77611314db87d981e2',NULL,0,NULL,NULL,'2017-11-18 17:15:31'),(3,4,'Mule 官方例子研究','<ol><li>求助：</li></ol><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://bbs.reactnative.cn/category/4/%E6%B1%82%E5%8A%A9%E4%B8%93%E5%8C%BA\">http://bbs.reactnative.cn/category/4/求助专区</a></div><div><br></div><div><br></div><ol><li>运行踩坑记</li></ol><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://www.jianshu.com/p/22aa14664cf9?open_source=weibo_search\">http://www.jianshu.com/p/22aa14664cf9?open_source=weibo_search</a></div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://localhost:8081/debugger-ui\">http://localhost:8081/debugger-ui</a></div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://localhost:8081/index.android.bundle?platform=android\">http://localhost:8081/index.android.bundle?platform=android</a></div><div><br></div><div>进入项目，在android/app/src/main下新建assets目录</div><div>在package.json中配置下面代码</div><div>\"scripts\":{</div><div>\"start\": \"node node_modules/react-native/local-cli/cli.js start\",</div><div>\"bundle-android\": \"react-native bundle --platform android --dev false --entry-file index.android.js --bundle-output app/src/main/assets/index.android.bundle --sourcemap-output app/src/main/assets/index.android.map --assets-dest android/app/src/main/res/\"</div><div>},</div><div><br></div><ol><li>安装踩坑</li></ol><div>MSBUILD : error MSB3428: 未能加载 Visual C++ 组件“VCBuild.exe”。要解决此问题，1) 安装 .NET Framework 2.0 SDK；2) 安装 Microsoft Visual Studio 2005；或 3) 如果将该组件安装到了其他位置，请将其位置添加到系统路径中。 [D:\\react-native-pro\\f8app-master\\f8app-master\\node_modules\\bufferutil\\build\\binding.sln]</div><div><br></div><div>参考 ：<a target=\"_blank\" rel=\"nofollow\" href=\"http://www.w2bc.com/article/103350\">http://www.w2bc.com/article/103350</a></div><ul><li>Python 2.7下载地址 &nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://www.python.org/downloads/\">https://www.python.org/downloads/</a>&nbsp;&nbsp;</li></ul><div>git &nbsp; 安装React-native需要用到git下载地址：<a target=\"_blank\" rel=\"nofollow\" href=\"https://git-for-windows.github.io/\">https://git-for-windows.github.io/</a></div><div>nodejs v5.7.0 Stable 下载网站&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://nodejs.org/en/\">https://nodejs.org/en/</a>&nbsp;&nbsp; &nbsp;</div><ul><li>react-native命令行从npm官方源拖代码时会遇上麻烦。请将npm仓库源替换为国内镜像：</li></ul><div>npm config set registry&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://registry.npm.taobao.org/\">https://registry.npm.taobao.org</a>&nbsp;npm config set disturl&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://npm.taobao.org/dist\">https://npm.taobao.org/dist</a></div><ul><li>&nbsp;npm install -g react-native-cli</li></ul><ul><li>命令行进入你希望创建项目的目录输入 &nbsp;react-native init AwesomeProject react-native start</li></ul><div><br></div><ol><li>错误：</li></ol><div>at Object.&lt;anonymous&gt; (D:\\react-native-pro\\learning-react-native-master\\WeatherProject\\node_modules\\react-native\\packager\\babelRegisterOnly.js:11:27)</div><div>先npm install 则如下：</div><div>rm -rf node_modules</div><div>npm install</div><div><br></div><div><br></div><ol><li>genymotion win10 踩坑</li></ol><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://blog.csdn.net/zhan1350441670/article/details/47975341\">http://blog.csdn.net/zhan1350441670/article/details/47975341</a></div><div>C:\\Users\\Administrator\\AppData\\Local</div><div>C:\\Users\\Administrator\\AppData\\Roaming</div><div>C:\\Users\\Administrator\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs</div><div>C:\\Users\\Administrator\\.bundle\\cache\\compact_index\\rubygems.org.443.29b0360b937aa4d161703e6160654e47\\info</div><div>C:/Users/Administrator/AppData/Local/Genymobile/</div><div>删除里面 virtualbox 文件，以及“硬件管理”删除多余网络链接，重新安装，</div><div>virtualbox 为4.点多 ，Genymobile 2.6 2.53 可以运行。</div><div><br></div><ol><li>运行踩坑记</li></ol><div>真机白屏</div><div>1.把应用的悬浮框权限开启</div><div>2.在手机上设置local ip和端口地址，才可以把js等资源下载到手机上进行调试。</div><div>react evaluating \'babelHelpers.typeof(global))</div><div><br></div><div><br></div><div>新版本babel，拆分成babel-cli和babel-core，你2个都要install。</div><div>babel 踩坑&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"http://www.imooc.com/article/11157\">http://www.imooc.com/article/11157</a></div><div><br></div><div>babel 编译插件</div><div>npm install babel-plugin-transform-react-jsx</div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://blog.csdn.net/github_26672553/article/details/52026687\">reactJS - 03利用babel来”编译”我们的脚本文件</a></div><div><br></div><div><br></div><div>react+webpack+babel才可以使用ES6&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://segmentfault.com/q/1010000003835383\">https://segmentfault.com/q/1010000003835383</a></div><div><br></div><ol><li>运行踩坑记</li></ol><div>Error:Error: File path too long on Windows, keep below 240 characters</div><div>在跟目录下的gradle.build 添加如下 allprojects { repositories { jcenter() mavenLocal() } buildDir = \"C:/tmp/${rootProject.name}/${project.name}\" }</div><div><br></div><ol><li>运行踩坑记</li></ol><div><br></div><div><br></div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://stackoverflow.com/questions/35050991/react-native-android-assembledebug-log-unknown-source-file-warning-string-c\">Unknown source file : warning: string \'catalyst_debugjs\' has no default translation</a></div><div>&nbsp;in&nbsp;build.gradle&nbsp;file.</div><div>Change</div><div>classpath \'com.android.tools.build:gradle:1.3.1\'</div><div>To</div><div>classpath \'com.android.tools.build:gradle:1.5.0\'</div><div><br></div><div><br></div><div><br></div><ol><li>运行踩坑记</li></ol><div>babelHelpers.typeof is not a function</div><div><br></div><div><br></div><div><br></div><ol><li>运行踩坑记</li></ol><div><br></div><div><br></div><div>npm install node-pre-gyp -g</div><div>npm uninstall -g watchman</div><div><br></div><div>Watchman: Watchman was not found in PATH. See&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://facebook.github.io/watchman/docs/install.html\">https://facebook.github.io/watchman/docs/install.html</a>&nbsp;for installation instructions</div><div>uninstall -g watchman</div><div><br></div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://www.cnblogs.com/agilee/p/5096974.html\">http://www.cnblogs.com/agilee/p/5096974.html</a></div><div>如果你下载的是最新版本，那么请安装cygwin，然后切换到node_modules\\react-native\\packager，然后运行：</div><div>./packager.sh --nonPersistent</div><div>注意一定要加--nonPersistent参数，否则会因为加载watchman而失败</div><div><br></div><div><br></div><div><br></div><div><br></div><ol><li>运行踩坑记</li></ol><div><br></div><div>ReactAndroid:buildReactNdkLib FAILED</div><div>原因为NDK 版本不对，必须gcc4.8，请选择&nbsp;Android NDK r10e&nbsp;对应系统下载安装</div><div><br></div><div><br></div><ol><li>运行踩坑记</li><li>运行踩坑记</li><li>运行踩坑记</li><li>运行踩坑记</li></ol><div><br></div><div><br></div><div>/app/data/quzhen/wp-content/themes/markbrick/functions.php</div><div>/app/data/quzhen/wp-content/themes/markbrick-----</div><div>/app/data/quzhen/wp-content/themes/markbrick</div>',0,'',0,'http://tb-video.bdstatic.com/tieba-smallvideo-transcode/10_51d807011d62fd941e90bcbfec3a4fdd_2.mp4',X'5B2220225D','ab77611314db87d981e2',NULL,0,NULL,NULL,'2017-11-18 17:15:31'),(4,3,'Mule 官方例子研究','<ol><li>求助：</li></ol><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://bbs.reactnative.cn/category/4/%E6%B1%82%E5%8A%A9%E4%B8%93%E5%8C%BA\">http://bbs.reactnative.cn/category/4/求助专区</a></div><div><br></div><div><br></div><ol><li>运行踩坑记</li></ol><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://www.jianshu.com/p/22aa14664cf9?open_source=weibo_search\" title=\"Link: http://www.jianshu.com/p/22aa14664cf9?open_source=weibo_search\">http://www.jianshu.com/p/22aa14664cf9?open_source=weibo_search</a></div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://localhost:8081/debugger-ui\">http://localhost:8081/debugger-ui</a></div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://localhost:8081/index.android.bundle?platform=android\">http://localhost:8081/index.android.bundle?platform=android</a></div><div><br></div><div>进入项目，在android/app/src/main下新建assets目录</div><div>在package.json中配置下面代码</div><div>\"scripts\":{</div><div>\"start\": \"node node_modules/react-native/local-cli/cli.js start\",</div><div>\"bundle-android\": \"react-native bundle --platform android --dev false --entry-file index.android.js --bundle-output app/src/main/assets/index.android.bundle --sourcemap-output app/src/main/assets/index.android.map --assets-dest android/app/src/main/res/\"</div><div>},</div><div><br></div><ol><li>安装踩坑</li></ol><div>MSBUILD : error MSB3428: 未能加载 Visual C++ 组件“VCBuild.exe”。要解决此问题，1) 安装 .NET Framework 2.0 SDK；2) 安装 Microsoft Visual Studio 2005；或 3) 如果将该组件安装到了其他位置，请将其位置添加到系统路径中。 [D:\\react-native-pro\\f8app-master\\f8app-master\\node_modules\\bufferutil\\build\\binding.sln]</div><div><br></div><div>参考 ：<a target=\"_blank\" rel=\"nofollow\" href=\"http://www.w2bc.com/article/103350\">http://www.w2bc.com/article/103350</a></div><ul><li>Python 2.7下载地址 &nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://www.python.org/downloads/\">https://www.python.org/downloads/</a>&nbsp;&nbsp;</li></ul><div>git &nbsp; 安装React-native需要用到git下载地址：<a target=\"_blank\" rel=\"nofollow\" href=\"https://git-for-windows.github.io/\">https://git-for-windows.github.io/</a></div><div>nodejs v5.7.0 Stable 下载网站&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://nodejs.org/en/\">https://nodejs.org/en/</a>&nbsp;&nbsp; &nbsp;</div><ul><li>react-native命令行从npm官方源拖代码时会遇上麻烦。请将npm仓库源替换为国内镜像：</li></ul><div>npm config set registry&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://registry.npm.taobao.org/\">https://registry.npm.taobao.org</a>&nbsp;npm config set disturl&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://npm.taobao.org/dist\">https://npm.taobao.org/dist</a></div><ul><li>&nbsp;npm install -g react-native-cli</li></ul><ul><li>命令行进入你希望创建项目的目录输入 &nbsp;react-native init AwesomeProject react-native start</li></ul><div><br></div><ol><li>错误：</li></ol><div>at Object.&lt;anonymous&gt; (D:\\react-native-pro\\learning-react-native-master\\WeatherProject\\node_modules\\react-native\\packager\\babelRegisterOnly.js:11:27)</div><div>先npm install 则如下：</div><div>rm -rf node_modules</div><div>npm install</div><div><br></div><div><br></div><ol><li>genymotion win10 踩坑</li></ol><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://blog.csdn.net/zhan1350441670/article/details/47975341\">http://blog.csdn.net/zhan1350441670/article/details/47975341</a></div><div>C:\\Users\\Administrator\\AppData\\Local</div><div>C:\\Users\\Administrator\\AppData\\Roaming</div><div>C:\\Users\\Administrator\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs</div><div>C:\\Users\\Administrator\\.bundle\\cache\\compact_index\\rubygems.org.443.29b0360b937aa4d161703e6160654e47\\info</div><div>C:/Users/Administrator/AppData/Local/Genymobile/</div><div>删除里面 virtualbox 文件，以及“硬件管理”删除多余网络链接，重新安装，</div><div>virtualbox 为4.点多 ，Genymobile 2.6 2.53 可以运行。</div><div><br></div><ol><li>运行踩坑记</li></ol><div>真机白屏</div><div>1.把应用的悬浮框权限开启</div><div>2.在手机上设置local ip和端口地址，才可以把js等资源下载到手机上进行调试。</div><div>react evaluating \'babelHelpers.typeof(global))</div><div><br></div><div><br></div><div>新版本babel，拆分成babel-cli和babel-core，你2个都要install。</div><div>babel 踩坑&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"http://www.imooc.com/article/11157\">http://www.imooc.com/article/11157</a></div><div><br></div><div>babel 编译插件</div><div>npm install babel-plugin-transform-react-jsx</div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://blog.csdn.net/github_26672553/article/details/52026687\">reactJS - 03利用babel来”编译”我们的脚本文件</a></div><div><br></div><div><br></div><div>react+webpack+babel才可以使用ES6&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://segmentfault.com/q/1010000003835383\">https://segmentfault.com/q/1010000003835383</a></div><div><br></div><ol><li>运行踩坑记</li></ol><div>Error:Error: File path too long on Windows, keep below 240 characters</div><div>在跟目录下的gradle.build 添加如下 allprojects { repositories { jcenter() mavenLocal() } buildDir = \"C:/tmp/${rootProject.name}/${project.name}\" }</div><div><br></div><ol><li>运行踩坑记</li></ol><div><br></div><div><br></div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://stackoverflow.com/questions/35050991/react-native-android-assembledebug-log-unknown-source-file-warning-string-c\">Unknown source file : warning: string \'catalyst_debugjs\' has no default translation</a></div><div>&nbsp;in&nbsp;build.gradle&nbsp;file.</div><div>Change</div><div>classpath \'com.android.tools.build:gradle:1.3.1\'</div><div>To</div><div>classpath \'com.android.tools.build:gradle:1.5.0\'</div><div><br></div><div><br></div><div><br></div><ol><li>运行踩坑记</li></ol><div>babelHelpers.typeof is not a function</div><div><br></div><div><br></div><div><br></div><ol><li>运行踩坑记</li></ol><div><br></div><div><br></div><div>npm install node-pre-gyp -g</div><div>npm uninstall -g watchman</div><div><br></div><div>Watchman: Watchman was not found in PATH. See&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://facebook.github.io/watchman/docs/install.html\">https://facebook.github.io/watchman/docs/install.html</a>&nbsp;for installation instructions</div><div>uninstall -g watchman</div><div><br></div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://www.cnblogs.com/agilee/p/5096974.html\">http://www.cnblogs.com/agilee/p/5096974.html</a></div><div>如果你下载的是最新版本，那么请安装cygwin，然后切换到node_modules\\react-native\\packager，然后运行：</div><div>./packager.sh --nonPersistent</div><div>注意一定要加--nonPersistent参数，否则会因为加载watchman而失败</div><div><br></div><div><br></div><div><br></div><div><br></div><ol><li>运行踩坑记</li></ol><div><br></div><div>ReactAndroid:buildReactNdkLib FAILED</div><div>原因为NDK 版本不对，必须gcc4.8，请选择&nbsp;Android NDK r10e&nbsp;对应系统下载安装</div><div><br></div><div><br></div><ol><li>运行踩坑记</li><li>运行踩坑记</li><li>运行踩坑记</li><li>运行踩坑记</li></ol><div><br></div><div><br></div><div>/app/data/quzhen/wp-content/themes/markbrick/functions.php</div><div>/app/data/quzhen/wp-content/themes/markbrick-----</div><div>/app/data/quzhen/wp-content/themes/markbrick</div>',0,'',0,'http://tb-video.bdstatic.com/tieba-smallvideo-transcode/10_51d807011d62fd941e90bcbfec3a4fdd_2.mp4',X'5B2220225D','ab77611314db87d981e2',NULL,0,NULL,NULL,'2017-11-18 17:17:35'),(5,1,'react','<ol><li>求助：</li></ol><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://bbs.reactnative.cn/category/4/%E6%B1%82%E5%8A%A9%E4%B8%93%E5%8C%BA\">http://bbs.reactnative.cn/category/4/求助专区</a></div><div><br></div><div><br></div><ol><li>运行踩坑记</li></ol><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://www.jianshu.com/p/22aa14664cf9?open_source=weibo_search\">http://www.jianshu.com/p/22aa14664cf9?open_source=weibo_search</a></div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://localhost:8081/debugger-ui\">http://localhost:8081/debugger-ui</a></div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://localhost:8081/index.android.bundle?platform=android\">http://localhost:8081/index.android.bundle?platform=android</a></div><div><br></div><div>进入项目，在android/app/src/main下新建assets目录</div><div>在package.json中配置下面代码</div><div>\"scripts\":{</div><div>\"start\": \"node node_modules/react-native/local-cli/cli.js start\",</div><div>\"bundle-android\": \"react-native bundle --platform android --dev false --entry-file index.android.js --bundle-output app/src/main/assets/index.android.bundle --sourcemap-output app/src/main/assets/index.android.map --assets-dest android/app/src/main/res/\"</div><div>},</div><div><br></div><ol><li>安装踩坑</li></ol><div>MSBUILD : error MSB3428: 未能加载 Visual C++ 组件“VCBuild.exe”。要解决此问题，1) 安装 .NET Framework 2.0 SDK；2) 安装 Microsoft Visual Studio 2005；或 3) 如果将该组件安装到了其他位置，请将其位置添加到系统路径中。 [D:\\react-native-pro\\f8app-master\\f8app-master\\node_modules\\bufferutil\\build\\binding.sln]</div><div><br></div><div>参考 ：<a target=\"_blank\" rel=\"nofollow\" href=\"http://www.w2bc.com/article/103350\">http://www.w2bc.com/article/103350</a></div><ul><li>Python 2.7下载地址 &nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://www.python.org/downloads/\">https://www.python.org/downloads/</a>&nbsp;&nbsp;</li></ul><div>git &nbsp; 安装React-native需要用到git下载地址：<a target=\"_blank\" rel=\"nofollow\" href=\"https://git-for-windows.github.io/\">https://git-for-windows.github.io/</a></div><div>nodejs v5.7.0 Stable 下载网站&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://nodejs.org/en/\">https://nodejs.org/en/</a>&nbsp;&nbsp; &nbsp;</div><ul><li>react-native命令行从npm官方源拖代码时会遇上麻烦。请将npm仓库源替换为国内镜像：</li></ul><div>npm config set registry&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://registry.npm.taobao.org/\">https://registry.npm.taobao.org</a>&nbsp;npm config set disturl&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://npm.taobao.org/dist\">https://npm.taobao.org/dist</a></div><ul><li>&nbsp;npm install -g react-native-cli</li></ul><ul><li>命令行进入你希望创建项目的目录输入 &nbsp;react-native init AwesomeProject react-native start</li></ul><div><br></div><ol><li>错误：</li></ol><div>at Object.&lt;anonymous&gt; (D:\\react-native-pro\\learning-react-native-master\\WeatherProject\\node_modules\\react-native\\packager\\babelRegisterOnly.js:11:27)</div><div>先npm install 则如下：</div><div>rm -rf node_modules</div><div>npm install</div><div><br></div><div><br></div><ol><li>genymotion win10 踩坑</li></ol><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://blog.csdn.net/zhan1350441670/article/details/47975341\">http://blog.csdn.net/zhan1350441670/article/details/47975341</a></div><div>C:\\Users\\Administrator\\AppData\\Local</div><div>C:\\Users\\Administrator\\AppData\\Roaming</div><div>C:\\Users\\Administrator\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs</div><div>C:\\Users\\Administrator\\.bundle\\cache\\compact_index\\rubygems.org.443.29b0360b937aa4d161703e6160654e47\\info</div><div>C:/Users/Administrator/AppData/Local/Genymobile/</div><div>删除里面 virtualbox 文件，以及“硬件管理”删除多余网络链接，重新安装，</div><div>virtualbox 为4.点多 ，Genymobile 2.6 2.53 可以运行。</div><div><br></div><ol><li>运行踩坑记</li></ol><div>真机白屏</div><div>1.把应用的悬浮框权限开启</div><div>2.在手机上设置local ip和端口地址，才可以把js等资源下载到手机上进行调试。</div><div>react evaluating \'babelHelpers.typeof(global))</div><div><br></div><div><br></div><div>新版本babel，拆分成babel-cli和babel-core，你2个都要install。</div><div>babel 踩坑&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"http://www.imooc.com/article/11157\">http://www.imooc.com/article/11157</a></div><div><br></div><div>babel 编译插件</div><div>npm install babel-plugin-transform-react-jsx</div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://blog.csdn.net/github_26672553/article/details/52026687\">reactJS - 03利用babel来”编译”我们的脚本文件</a></div><div><br></div><div><br></div><div>react+webpack+babel才可以使用ES6&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://segmentfault.com/q/1010000003835383\">https://segmentfault.com/q/1010000003835383</a></div><div><br></div><ol><li>运行踩坑记</li></ol><div>Error:Error: File path too long on Windows, keep below 240 characters</div><div>在跟目录下的gradle.build 添加如下 allprojects { repositories { jcenter() mavenLocal() } buildDir = \"C:/tmp/${rootProject.name}/${project.name}\" }</div><div><br></div><ol><li>运行踩坑记</li></ol><div><br></div><div><br></div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://stackoverflow.com/questions/35050991/react-native-android-assembledebug-log-unknown-source-file-warning-string-c\">Unknown source file : warning: string \'catalyst_debugjs\' has no default translation</a></div><div>&nbsp;in&nbsp;build.gradle&nbsp;file.</div><div>Change</div><div>classpath \'com.android.tools.build:gradle:1.3.1\'</div><div>To</div><div>classpath \'com.android.tools.build:gradle:1.5.0\'</div><div><br></div><div><br></div><div><br></div><ol><li>运行踩坑记</li></ol><div>babelHelpers.typeof is not a function</div><div><br></div><div><br></div><div><br></div><ol><li>运行踩坑记</li></ol><div><br></div><div><br></div><div>npm install node-pre-gyp -g</div><div>npm uninstall -g watchman</div><div><br></div><div>Watchman: Watchman was not found in PATH. See&nbsp;<a target=\"_blank\" rel=\"nofollow\" href=\"https://facebook.github.io/watchman/docs/install.html\">https://facebook.github.io/watchman/docs/install.html</a>&nbsp;for installation instructions</div><div>uninstall -g watchman</div><div><br></div><div><a target=\"_blank\" rel=\"nofollow\" href=\"http://www.cnblogs.com/agilee/p/5096974.html\">http://www.cnblogs.com/agilee/p/5096974.html</a></div><div>如果你下载的是最新版本，那么请安装cygwin，然后切换到node_modules\\react-native\\packager，然后运行：</div><div>./packager.sh --nonPersistent</div><div>注意一定要加--nonPersistent参数，否则会因为加载watchman而失败</div><div><br></div><div><br></div><div><br></div><div><br></div><ol><li>运行踩坑记</li></ol><div><br></div><div>ReactAndroid:buildReactNdkLib FAILED</div><div>原因为NDK 版本不对，必须gcc4.8，请选择&nbsp;Android NDK r10e&nbsp;对应系统下载安装</div><div><br></div><div><br></div><ol><li>运行踩坑记</li><li>运行踩坑记</li><li>运行踩坑记</li><li>运行踩坑记</li></ol><div><br></div><div><br></div><div>/app/data/quzhen/wp-content/themes/markbrick/functions.php</div><div>/app/data/quzhen/wp-content/themes/markbrick-----</div><div>/app/data/quzhen/wp-content/themes/markbrick</div>',0,'',0,'http://tb-video.bdstatic.com/tieba-smallvideo-transcode/10_51d807011d62fd941e90bcbfec3a4fdd_2.mp4',X'5B2220225D','ab77611314db87d981e2',NULL,0,NULL,NULL,'2017-11-18 17:18:17'),(6,1,'手动将本地jar添加到Maven仓库','<div>我们有两种方法解决这种问题：</div><div>1.进入开发者模式，关闭 “MIUI优化”</div><div>2.唤醒提示框&nbsp;</div><div><br></div><div>安装成功后是白屏</div><div>设置 -&gt; 应用管理 -&gt; 我们安装的 react-native 应用 -&gt; 权限管理，打开悬浮窗权限</div><div>或</div><div>设置 -&gt;其他高级设置-&gt;悬浮球 </div><div><br></div><div>改最外层工程的 build.gradle 配置, 降低 gradle的 build 为1.2.3版本.</div><div>buildscript {\n    repositories {\n        jcenter()\n        mavenLocal()\n    }\n    dependencies {\n        classpath \'com.android.tools.build:gradle:1.2.3\' // 修改1.2.3\n        classpath \'de.undercouch:gradle-download-task:2.0.0\'\n\n        // NOTE: Do not place your application dependencies here; they belong\n        // in the individual module build.gradle files\n    }\n}\n</div><div>并且设置 Gradle 的 Wrapper为 gradle-2.2-all.zip</div><div><br></div><div><br></div><div>使用npm安装一些包失败了的看过来</div><div>3.编辑 ~/.npmrc 加入下面内容</div><div>registry = <a target=\"_blank\" rel=\"nofollow\" href=\"https://registry.npm.taobao.org\">https://registry.npm.taobao.org</a></div><div><br></div><div><br></div><div><br></div><div><br></div><div>babel</div><div>这是一个补完babel支持es6的拓展包，配置步骤为3个</div><div>1.打开命令行键入 npm install --save-dev babel-polyfill 安装polyfill</div><div><span>2.在webpack.config.j</span></div>',73,'http://soupu.oss-cn-shanghai.aliyuncs.com/images/Screenshot_2016-12-13-10-19-12-215.png',0,'http://tb-video.bdstatic.com/tieba-smallvideo-transcode/10_51d807011d62fd941e90bcbfec3a4fdd_2.mp4',X'5B2220225D','ab77611314db87d981e2',NULL,0,NULL,NULL,'2017-11-19 16:39:52'),(7,0,'《高山流水》 - 古筝','高山流水，梅花三弄，夕阳箫鼓，汉宫秋月，阳春白雪，渔樵问答，胡笳十八拍，广陵散，平沙落雁，十面埋伏。',0,'http://soupu.oss-cn-shanghai.aliyuncs.com/images/Screenshot_2016-12-13-10-19-12-215.png',NULL,NULL,NULL,'adab1954834a81025',595,0,NULL,NULL,'2017-11-27 15:54:25'),(9,0,'女儿情-西游记 电视剧配乐原声','九九八十一难，最难过的，其实是女儿国这一关，因为比起其他的艰难困苦来说，此时的唐僧是真的动心了，一句“来生若有缘分”道尽一切，只是为了心中崇高的理想，纵使心动也要断绝柔情继续西行。为国王惋惜，同时也对唐僧充满崇敬，尤其是了解了史上真实的唐玄奘以后，更是觉得此人了不起。',0,'http://soupu.oss-cn-shanghai.aliyuncs.com/images/banner2.jpg',NULL,NULL,NULL,'adab1936615a63721',222,0,NULL,NULL,'2017-11-27 15:56:30'),(10,0,'犯错-双管巴乌','小哥的声音真好。《一剪梅》改了这么多版，还是这版耐听。如泣如诉，余音袅袅。',0,'http://soupu.oss-cn-shanghai.aliyuncs.com/images/Screenshot_2016-12-13-10-13-16-926.png',NULL,NULL,NULL,'adab180872a187745',2113,0,NULL,NULL,'2017-11-27 15:56:30'),(11,0,'车站-双管巴乌','虽然但现在为止还没有去过彩云之南，但是这支曲子几乎包含了我全部的关于那里的畅想：绿油油的树林，精巧的竹楼，还有美丽的月光……太美了……',0,'http://soupu.oss-cn-shanghai.aliyuncs.com/images/Screenshot_2016-12-13-10-13-38-305.png',NULL,NULL,NULL,'adab1721467a468354',80,0,NULL,NULL,'2017-11-27 15:56:30'),(12,0,'美丽的神话-孙楠','自从张艺谋《英雄》之后，国内开始了“拍大片”潮流，05年《无极》《神话》扎堆贺岁，《无极》因为《一个馒头引发的血案》成就了张柏芝谢霆锋的预言片，也算神作。《神话》剧情平平，只留下这首歌，记得这歌05年火了整整一整年啊，我惨绿的高中岁月啊。',0,'http://soupu.oss-cn-shanghai.aliyuncs.com/images/banner5.jpg',NULL,NULL,NULL,'adab1418702a21454',810,0,NULL,NULL,'2017-11-27 15:56:30'),(13,0,'赛马-二胡独奏','想起来武林外传里有一集，老白他们挖地道，小六拉这个曲，最后老白掉地道里了哈哈哈哈哈',0,'http://soupu.oss-cn-shanghai.aliyuncs.com/images/banner6.jpg',NULL,NULL,NULL,'adab1418061a741425',134,0,NULL,NULL,'2017-11-27 15:56:30'),(14,0,'痴情冢-电视剧《新天龙八部》主题曲','塞上旧约终成空，夜阑魂归应梦同。纵死未肯忘心盟，何妨濡沫泥涂中。雁字依稀相思浓，女儿痴情谁与共？从此相见殊参商，却无画图忆姣容。地匝万芦一鸿起，老翅不回缘情重。碧落黄泉两孤冢，君自南北我西东。”写了个同人，唱起来佶屈聱牙，但似乎比原歌词稍微贴合一点。',0,'http://soupu.oss-cn-shanghai.aliyuncs.com/images/bg0.jpg',NULL,NULL,NULL,NULL,80,0,NULL,NULL,'2017-11-27 15:56:30'),(15,0,'西海情歌-降央卓玛','前天看了CCTV的top10点播的这首歌，现场版的，感觉歌手很美，歌声也犹如天籁',0,'http://soupu.oss-cn-shanghai.aliyuncs.com/images/bg01.jpg',NULL,NULL,NULL,NULL,80,0,NULL,NULL,'2017-11-27 15:56:30');

#
# Structure for table "cn_user"
#
...
CREATE TABLE `cn_user` (
  ...
  `gender` tinyint(1) DEFAULT NULL COMMENT '1 男 0女',
  `province` varchar(255) DEFAULT NULL,
  `city` varchar(255) DEFAULT NULL,
  `phoneNumber` varchar(11) DEFAULT NULL,
  `countryCode` int(3) DEFAULT NULL,
  `birthday` date DEFAULT NULL,
  `post` varchar(255) DEFAULT NULL COMMENT '职业',
  `introduce` varchar(255) DEFAULT NULL,
  `resumeId` varchar(20) DEFAULT NULL COMMENT '简历id',
  `code` varchar(1000) DEFAULT NULL COMMENT 'HTTPS 接口，开发者服务器使用登录凭证 code 获取 session_key 和 openid',
  `session_key` varchar(1000) DEFAULT NULL COMMENT '对用户数据进行加密签名的密钥',
  `unionid` varchar(1000) DEFAULT NULL COMMENT '用户在开放平台的唯一标识符',
  `livingprovince` varchar(255) DEFAULT NULL,
  `livingcity` varchar(255) DEFAULT NULL COMMENT '所在城市',
  `isFree` varchar(255) DEFAULT NULL COMMENT '在职 离职',
  `education` varchar(255) DEFAULT NULL COMMENT '学历',
  `educationYear` varchar(255) DEFAULT NULL COMMENT '毕业时间',
...
DROP TABLE IF EXISTS `cn_vue_user`;
CREATE TABLE `cn_vue_user` (
  ...
  PRIMARY KEY (`account`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='cn_weixin_user  主要依据微信授权';

#
# Data for table "cn_vue_user"
#

INSERT INTO `cn_vue_user` VALUES ('ab77611314db87d981e2','http://wx.qlogo.cn/mmhead/Q3auHgzwzM7xSlicoNic07QoCb2OIwDoG9PzQ6TyqOHLdx4okTHUCnIw/132','刘勇俊',1,'Hunan','深圳','18685200001',NULL,'1998-01-01','','','10000008','10000002','','','广东','广州','在职','保密','2001-07-30',32,'jumny','学生','liuyongjun','123456');

#
# Structure for table "test_json"
#
...
#
# Data for table "test_json"
#

INSERT INTO `test_json` VALUES (8,'{\n    \"rows\": [\n        {\n            \"level\": 0,\n            \"product_no\": \"a0000052\",\n            \"qc_option\": [\n                {\n                    \"qc_option_no\": \"a1000-2131\",\n                    \"qc_value\": \"10\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-3026\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-3370\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-4802\",\n                    \"qc_value\": \"11\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-5228\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-6046\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-9765\",\n                    \"qc_value\": \"21\"\n                }\n            ]\n        },\n        {\n            \"level\": 0,\n            \"product_no\": \"a0000053\",\n            \"qc_option\": [\n                {\n                    \"qc_option_no\": \"a1000-2131\",\n                    \"qc_value\": \"10\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-3026\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-3370\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-4802\",\n                    \"qc_value\": \"11\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-5228\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-6046\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-9765\",\n                    \"qc_value\": \"21\"\n                }\n            ]\n        },\n        {\n            \"level\": 0,\n            \"product_no\": \"a0000054\",\n            \"qc_option\": [\n                {\n                    \"qc_option_no\": \"a1000-2131\",\n                    \"qc_value\": \"10\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-3026\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-3370\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-4802\",\n                    \"qc_value\": \"11\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-5228\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-6046\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-9765\",\n                    \"qc_value\": \"21\"\n                }\n            ]\n        },\n        {\n            \"level\": 0,\n            \"product_no\": \"a0000055\",\n            \"qc_option\": [\n                {\n                    \"qc_option_no\": \"a1000-2131\",\n                    \"qc_value\": \"10\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-3026\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-3370\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-4802\",\n                    \"qc_value\": \"11\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-5228\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-6046\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-9765\",\n                    \"qc_value\": \"21\"\n                }\n            ]\n        },\n        {\n            \"level\": 0,\n            \"product_no\": \"a0000056\",\n            \"qc_option\": [\n                {\n                    \"qc_option_no\": \"a1000-2131\",\n                    \"qc_value\": \"10\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-3026\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-3370\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-4802\",\n                    \"qc_value\": \"11\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-5228\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-6046\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-9765\",\n                    \"qc_value\": \"21\"\n                }\n            ]\n        }\n    ]\n}'),(9,'{\"rows\": [{\"um\": \"5af5\", \"type\": \"0\", \"level\": \"0\", \"qc_no\": \"20170118-a006\", \"remark\": null, \"status\": \"0\", \"mt_code\": \"2ab396d4\", \"mt_name\": \"111222\", \"mt_spec\": \"d553\", \"qc_date\": \"0000-00-00 00:00:00\", \"abc_code\": null, \"batch_no\": \"2016121209404879\", \"mt_price\": \"120.00\", \"order_no\": \"\", \"keyin_date\": \"0000-00-00 00:00:00\", \"keyin_user\": \"\", \"limit_days\": \"10\", \"process_no\": \"a002\", \"product_no\": \"a0000007\", \"qc_user_id\": \"\", \"short_name\": \"\", \"storage_id\": null, \"day_plan_no\": \"a10006424\", \"qc_code_jpg\": \"\", \"mt_spec_desc\": \"111333\", \"order_slv_no\": \"\", \"product_date\": \"2016-12-15 11:23:42\", \"product_name\": \"0x1213\", \"a1000-2131-key\": \" u62bdu7ebf \", \"a1000-2131-val\": \"10\", \"a1000-3026-key\": \"u957fu5ea6\", \"a1000-3026-val\": \"21\", \"a1000-3370-key\": \"u5bbdu5ea6\", \"a1000-3370-val\": \"21\", \"a1000-4802-key\": \"u91cdu91cf\", \"a1000-4802-val\": \"11\", \"a1000-5228-key\": \"u539au5ea6\", \"a1000-5228-val\": \"21\", \"a1000-6046-key\": \"u6c34u5206\", \"a1000-6046-val\": \"21\", \"a1000-9765-key\": \"u5e45u5bbd\", \"a1000-9765-val\": \"21\", \"process_no_flag\": \"JP000001\"}, {\"um\": \"5af5\", \"type\": \"0\", \"level\": \"0\", \"qc_no\": \"20170118-a006\", \"remark\": null, \"status\": \"0\", \"mt_code\": \"2ab396d4\", \"mt_name\": \"111222\", \"mt_spec\": \"d553\", \"qc_date\": \"0000-00-00 00:00:00\", \"abc_code\": null, \"batch_no\": \"2016121209404879\", \"mt_price\": \"120.00\", \"order_no\": \"\", \"keyin_date\": \"0000-00-00 00:00:00\", \"keyin_user\": \"\", \"limit_days\": \"10\", \"process_no\": \"a002\", \"product_no\": \"a0000009\", \"qc_user_id\": \"\", \"short_name\": \"\", \"storage_id\": null, \"day_plan_no\": \"a10006424\", \"qc_code_jpg\": \"\", \"mt_spec_desc\": \"111333\", \"order_slv_no\": \"\", \"product_date\": \"2016-12-15 11:23:42\", \"product_name\": \"0x1213\", \"a1000-2131-key\": \" u62bdu7ebf \", \"a1000-2131-val\": \"10\", \"a1000-3026-key\": \"u957fu5ea6\", \"a1000-3026-val\": \"21\", \"a1000-3370-key\": \"u5bbdu5ea6\", \"a1000-3370-val\": \"21\", \"a1000-4802-key\": \"u91cdu91cf\", \"a1000-4802-val\": \"11\", \"a1000-5228-key\": \"u539au5ea6\", \"a1000-5228-val\": \"21\", \"a1000-6046-key\": \"u6c34u5206\", \"a1000-6046-val\": \"21\", \"a1000-9765-key\": \"u5e45u5bbd\", \"a1000-9765-val\": \"21\", \"process_no_flag\": \"JP000002\"}, {\"um\": \"5af5\", \"type\": \"0\", \"level\": \"0\", \"qc_no\": \"20170118-a006\", \"remark\": null, \"status\": \"0\", \"mt_code\": \"2ab396d4\", \"mt_name\": \"111222\", \"mt_spec\": \"d553\", \"qc_date\": \"0000-00-00 00:00:00\", \"abc_code\": null, \"batch_no\": \"2016121209404879\", \"mt_price\": \"120.00\", \"order_no\": \"\", \"keyin_date\": \"0000-00-00 00:00:00\", \"keyin_user\": \"\", \"limit_days\": \"10\", \"process_no\": \"a002\", \"product_no\": \"a000000a\", \"qc_user_id\": \"\", \"short_name\": \"\", \"storage_id\": null, \"day_plan_no\": \"a10006424\", \"qc_code_jpg\": \"\", \"mt_spec_desc\": \"111333\", \"order_slv_no\": \"\", \"product_date\": \"2016-12-15 11:23:42\", \"product_name\": \"0x1213\", \"a1000-2131-key\": \" u62bdu7ebf \", \"a1000-2131-val\": \"10\", \"a1000-3026-key\": \"u957fu5ea6\", \"a1000-3026-val\": \"21\", \"a1000-3370-key\": \"u5bbdu5ea6\", \"a1000-3370-val\": \"21\", \"a1000-4802-key\": \"u91cdu91cf\", \"a1000-4802-val\": \"11\", \"a1000-5228-key\": \"u539au5ea6\", \"a1000-5228-val\": \"21\", \"a1000-6046-key\": \"u6c34u5206\", \"a1000-6046-val\": \"21\", \"a1000-9765-key\": \"u5e45u5bbd\", \"a1000-9765-val\": \"21\", \"process_no_flag\": \"JP000002\"}, {\"um\": \"5af5\", \"type\": \"0\", \"level\": \"0\", \"qc_no\": \"20170118-a006\", \"remark\": null, \"status\": \"0\", \"mt_code\": \"2ab396d4\", \"mt_name\": \"111222\", \"mt_spec\": \"d553\", \"qc_date\": \"0000-00-00 00:00:00\", \"abc_code\": null, \"batch_no\": \"2016121209404879\", \"mt_price\": \"120.00\", \"order_no\": \"\", \"keyin_date\": \"0000-00-00 00:00:00\", \"keyin_user\": \"\", \"limit_days\": \"10\", \"process_no\": \"a002\", \"product_no\": \"a000000b\", \"qc_user_id\": \"\", \"short_name\": \"\", \"storage_id\": null, \"day_plan_no\": \"a10006424\", \"qc_code_jpg\": \"\", \"mt_spec_desc\": \"111333\", \"order_slv_no\": \"\", \"product_date\": \"2016-12-15 11:23:42\", \"product_name\": \"0x1213\", \"a1000-2131-key\": \" u62bdu7ebf \", \"a1000-2131-val\": \"10\", \"a1000-3026-key\": \"u957fu5ea6\", \"a1000-3026-val\": \"21\", \"a1000-3370-key\": \"u5bbdu5ea6\", \"a1000-3370-val\": \"21\", \"a1000-4802-key\": \"u91cdu91cf\", \"a1000-4802-val\": \"11\", \"a1000-5228-key\": \"u539au5ea6\", \"a1000-5228-val\": \"21\", \"a1000-6046-key\": \"u6c34u5206\", \"a1000-6046-val\": \"21\", \"a1000-9765-key\": \"u5e45u5bbd\", \"a1000-9765-val\": \"21\", \"process_no_flag\": \"JP000002\"}, {\"um\": \"5af5\", \"type\": \"0\", \"level\": \"0\", \"qc_no\": \"20170118-a006\", \"remark\": null, \"status\": \"0\", \"mt_code\": \"2ab396d4\", \"mt_name\": \"111222\", \"mt_spec\": \"d553\", \"qc_date\": \"0000-00-00 00:00:00\", \"abc_code\": null, \"batch_no\": \"2016121209404879\", \"mt_price\": \"120.00\", \"order_no\": \"\", \"keyin_date\": \"0000-00-00 00:00:00\", \"keyin_user\": \"\", \"limit_days\": \"10\", \"process_no\": \"a002\", \"product_no\": \"a000000c\", \"qc_user_id\": \"\", \"short_name\": \"\", \"storage_id\": null, \"day_plan_no\": \"a10006424\", \"qc_code_jpg\": \"\", \"mt_spec_desc\": \"111333\", \"order_slv_no\": \"\", \"product_date\": \"2016-12-15 11:23:42\", \"product_name\": \"0x1213\", \"a1000-2131-key\": \" u62bdu7ebf \", \"a1000-2131-val\": \"10\", \"a1000-3026-key\": \"u957fu5ea6\", \"a1000-3026-val\": \"21\", \"a1000-3370-key\": \"u5bbdu5ea6\", \"a1000-3370-val\": \"21\", \"a1000-4802-key\": \"u91cdu91cf\", \"a1000-4802-val\": \"11\", \"a1000-5228-key\": \"u539au5ea6\", \"a1000-5228-val\": \"21\", \"a1000-6046-key\": \"u6c34u5206\", \"a1000-6046-val\": \"21\", \"a1000-9765-key\": \"u5e45u5bbd\", \"a1000-9765-val\": \"21\", \"process_no_flag\": \"JP000002\"}, {\"um\": \"5af5\", \"type\": \"0\", \"level\": \"0\", \"qc_no\": \"20170118-a006\", \"remark\": null, \"status\": \"0\", \"mt_code\": \"2ab396d4\", \"mt_name\": \"111222\", \"mt_spec\": \"d553\", \"qc_date\": \"0000-00-00 00:00:00\", \"abc_code\": null, \"batch_no\": \"2016121209404879\", \"mt_price\": \"120.00\", \"order_no\": \"\", \"keyin_date\": \"0000-00-00 00:00:00\", \"keyin_user\": \"\", \"limit_days\": \"10\", \"process_no\": \"a002\", \"product_no\": \"a000000d\", \"qc_user_id\": \"\", \"short_name\": \"\", \"storage_id\": null, \"day_plan_no\": \"a10006424\", \"qc_code_jpg\": \"\", \"mt_spec_desc\": \"111333\", \"order_slv_no\": \"\", \"product_date\": \"2016-12-15 11:23:42\", \"product_name\": \"0x1213\", \"a1000-2131-key\": \" u62bdu7ebf \", \"a1000-2131-val\": \"10\", \"a1000-3026-key\": \"u957fu5ea6\", \"a1000-3026-val\": \"21\", \"a1000-3370-key\": \"u5bbdu5ea6\", \"a1000-3370-val\": \"21\", \"a1000-4802-key\": \"u91cdu91cf\", \"a1000-4802-val\": \"11\", \"a1000-5228-key\": \"u539au5ea6\", \"a1000-5228-val\": \"21\", \"a1000-6046-key\": \"u6c34u5206\", \"a1000-6046-val\": \"21\", \"a1000-9765-key\": \"u5e45u5bbd\", \"a1000-9765-val\": \"21\", \"process_no_flag\": \"JP000003\"}, {\"um\": \"5af5\", \"type\": \"0\", \"level\": \"0\", \"qc_no\": \"20170118-a006\", \"remark\": null, \"status\": \"0\", \"mt_code\": \"2ab396d4\", \"mt_name\": \"111222\", \"mt_spec\": \"d553\", \"qc_date\": \"0000-00-00 00:00:00\", \"abc_code\": null, \"batch_no\": \"2016121209404879\", \"mt_price\": \"120.00\", \"order_no\": \"\", \"keyin_date\": \"0000-00-00 00:00:00\", \"keyin_user\": \"\", \"limit_days\": \"10\", \"process_no\": \"a002\", \"product_no\": \"a000000e\", \"qc_user_id\": \"\", \"short_name\": \"\", \"storage_id\": null, \"day_plan_no\": \"a10006424\", \"qc_code_jpg\": \"\", \"mt_spec_desc\": \"111333\", \"order_slv_no\": \"\", \"product_date\": \"2016-12-15 11:23:42\", \"product_name\": \"0x1213\", \"a1000-2131-key\": \" u62bdu7ebf \", \"a1000-2131-val\": \"10\", \"a1000-3026-key\": \"u957fu5ea6\", \"a1000-3026-val\": \"21\", \"a1000-3370-key\": \"u5bbdu5ea6\", \"a1000-3370-val\": \"21\", \"a1000-4802-key\": \"u91cdu91cf\", \"a1000-4802-val\": \"11\", \"a1000-5228-key\": \"u539au5ea6\", \"a1000-5228-val\": \"21\", \"a1000-6046-key\": \"u6c34u5206\", \"a1000-6046-val\": \"21\", \"a1000-9765-key\": \"u5e45u5bbd\", \"a1000-9765-val\": \"21\", \"process_no_flag\": \"JP000003\"}]}'),(10,'{\"rows\": [{\"um\": \"5af5\", \"type\": \"0\", \"level\": \"0\", \"qc_no\": \"20170118-a006\", \"remark\": null, \"status\": \"0\", \"mt_code\": \"2ab396d4\", \"mt_name\": \"111222\", \"mt_spec\": \"d553\", \"qc_date\": \"0000-00-00 00:00:00\", \"abc_code\": null, \"batch_no\": \"2016121209404879\", \"mt_price\": \"120.00\", \"order_no\": \"\", \"keyin_date\": \"0000-00-00 00:00:00\", \"keyin_user\": \"\", \"limit_days\": \"10\", \"process_no\": \"a002\", \"product_no\": \"a0000007\", \"qc_user_id\": \"\", \"short_name\": \"\", \"storage_id\": null, \"day_plan_no\": \"a10006424\", \"qc_code_jpg\": \"\", \"mt_spec_desc\": \"111333\", \"order_slv_no\": \"\", \"product_date\": \"2016-12-15 11:23:42\", \"product_name\": \"0x1213\", \"a1000-2131-key\": \" u62bdu7ebf \", \"a1000-2131-val\": \"10\", \"a1000-3026-key\": \"u957fu5ea6\", \"a1000-3026-val\": \"21\", \"a1000-3370-key\": \"u5bbdu5ea6\", \"a1000-3370-val\": \"21\", \"a1000-4802-key\": \"u91cdu91cf\", \"a1000-4802-val\": \"11\", \"a1000-5228-key\": \"u539au5ea6\", \"a1000-5228-val\": \"21\", \"a1000-6046-key\": \"u6c34u5206\", \"a1000-6046-val\": \"21\", \"a1000-9765-key\": \"u5e45u5bbd\", \"a1000-9765-val\": \"21\", \"process_no_flag\": \"JP000001\"}, {\"um\": \"5af5\", \"type\": \"0\", \"level\": \"0\", \"qc_no\": \"20170118-a006\", \"remark\": null, \"status\": \"0\", \"mt_code\": \"2ab396d4\", \"mt_name\": \"111222\", \"mt_spec\": \"d553\", \"qc_date\": \"0000-00-00 00:00:00\", \"abc_code\": null, \"batch_no\": \"2016121209404879\", \"mt_price\": \"120.00\", \"order_no\": \"\", \"keyin_date\": \"0000-00-00 00:00:00\", \"keyin_user\": \"\", \"limit_days\": \"10\", \"process_no\": \"a002\", \"product_no\": \"a0000009\", \"qc_user_id\": \"\", \"short_name\": \"\", \"storage_id\": null, \"day_plan_no\": \"a10006424\", \"qc_code_jpg\": \"\", \"mt_spec_desc\": \"111333\", \"order_slv_no\": \"\", \"product_date\": \"2016-12-15 11:23:42\", \"product_name\": \"0x1213\", \"a1000-2131-key\": \" u62bdu7ebf \", \"a1000-2131-val\": \"10\", \"a1000-3026-key\": \"u957fu5ea6\", \"a1000-3026-val\": \"21\", \"a1000-3370-key\": \"u5bbdu5ea6\", \"a1000-3370-val\": \"21\", \"a1000-4802-key\": \"u91cdu91cf\", \"a1000-4802-val\": \"11\", \"a1000-5228-key\": \"u539au5ea6\", \"a1000-5228-val\": \"21\", \"a1000-6046-key\": \"u6c34u5206\", \"a1000-6046-val\": \"21\", \"a1000-9765-key\": \"u5e45u5bbd\", \"a1000-9765-val\": \"21\", \"process_no_flag\": \"JP000002\"}, {\"um\": \"5af5\", \"type\": \"0\", \"level\": \"0\", \"qc_no\": \"20170118-a006\", \"remark\": null, \"status\": \"0\", \"mt_code\": \"2ab396d4\", \"mt_name\": \"111222\", \"mt_spec\": \"d553\", \"qc_date\": \"0000-00-00 00:00:00\", \"abc_code\": null, \"batch_no\": \"2016121209404879\", \"mt_price\": \"120.00\", \"order_no\": \"\", \"keyin_date\": \"0000-00-00 00:00:00\", \"keyin_user\": \"\", \"limit_days\": \"10\", \"process_no\": \"a002\", \"product_no\": \"a000000a\", \"qc_user_id\": \"\", \"short_name\": \"\", \"storage_id\": null, \"day_plan_no\": \"a10006424\", \"qc_code_jpg\": \"\", \"mt_spec_desc\": \"111333\", \"order_slv_no\": \"\", \"product_date\": \"2016-12-15 11:23:42\", \"product_name\": \"0x1213\", \"a1000-2131-key\": \" u62bdu7ebf \", \"a1000-2131-val\": \"10\", \"a1000-3026-key\": \"u957fu5ea6\", \"a1000-3026-val\": \"21\", \"a1000-3370-key\": \"u5bbdu5ea6\", \"a1000-3370-val\": \"21\", \"a1000-4802-key\": \"u91cdu91cf\", \"a1000-4802-val\": \"11\", \"a1000-5228-key\": \"u539au5ea6\", \"a1000-5228-val\": \"21\", \"a1000-6046-key\": \"u6c34u5206\", \"a1000-6046-val\": \"21\", \"a1000-9765-key\": \"u5e45u5bbd\", \"a1000-9765-val\": \"21\", \"process_no_flag\": \"JP000002\"}, {\"um\": \"5af5\", \"type\": \"0\", \"level\": \"0\", \"qc_no\": \"20170118-a006\", \"remark\": null, \"status\": \"0\", \"mt_code\": \"2ab396d4\", \"mt_name\": \"111222\", \"mt_spec\": \"d553\", \"qc_date\": \"0000-00-00 00:00:00\", \"abc_code\": null, \"batch_no\": \"2016121209404879\", \"mt_price\": \"120.00\", \"order_no\": \"\", \"keyin_date\": \"0000-00-00 00:00:00\", \"keyin_user\": \"\", \"limit_days\": \"10\", \"process_no\": \"a002\", \"product_no\": \"a000000b\", \"qc_user_id\": \"\", \"short_name\": \"\", \"storage_id\": null, \"day_plan_no\": \"a10006424\", \"qc_code_jpg\": \"\", \"mt_spec_desc\": \"111333\", \"order_slv_no\": \"\", \"product_date\": \"2016-12-15 11:23:42\", \"product_name\": \"0x1213\", \"a1000-2131-key\": \" u62bdu7ebf \", \"a1000-2131-val\": \"10\", \"a1000-3026-key\": \"u957fu5ea6\", \"a1000-3026-val\": \"21\", \"a1000-3370-key\": \"u5bbdu5ea6\", \"a1000-3370-val\": \"21\", \"a1000-4802-key\": \"u91cdu91cf\", \"a1000-4802-val\": \"11\", \"a1000-5228-key\": \"u539au5ea6\", \"a1000-5228-val\": \"21\", \"a1000-6046-key\": \"u6c34u5206\", \"a1000-6046-val\": \"21\", \"a1000-9765-key\": \"u5e45u5bbd\", \"a1000-9765-val\": \"21\", \"process_no_flag\": \"JP000002\"}, {\"um\": \"5af5\", \"type\": \"0\", \"level\": \"0\", \"qc_no\": \"20170118-a006\", \"remark\": null, \"status\": \"0\", \"mt_code\": \"2ab396d4\", \"mt_name\": \"111222\", \"mt_spec\": \"d553\", \"qc_date\": \"0000-00-00 00:00:00\", \"abc_code\": null, \"batch_no\": \"2016121209404879\", \"mt_price\": \"120.00\", \"order_no\": \"\", \"keyin_date\": \"0000-00-00 00:00:00\", \"keyin_user\": \"\", \"limit_days\": \"10\", \"process_no\": \"a002\", \"product_no\": \"a000000c\", \"qc_user_id\": \"\", \"short_name\": \"\", \"storage_id\": null, \"day_plan_no\": \"a10006424\", \"qc_code_jpg\": \"\", \"mt_spec_desc\": \"111333\", \"order_slv_no\": \"\", \"product_date\": \"2016-12-15 11:23:42\", \"product_name\": \"0x1213\", \"a1000-2131-key\": \" u62bdu7ebf \", \"a1000-2131-val\": \"10\", \"a1000-3026-key\": \"u957fu5ea6\", \"a1000-3026-val\": \"21\", \"a1000-3370-key\": \"u5bbdu5ea6\", \"a1000-3370-val\": \"21\", \"a1000-4802-key\": \"u91cdu91cf\", \"a1000-4802-val\": \"11\", \"a1000-5228-key\": \"u539au5ea6\", \"a1000-5228-val\": \"21\", \"a1000-6046-key\": \"u6c34u5206\", \"a1000-6046-val\": \"21\", \"a1000-9765-key\": \"u5e45u5bbd\", \"a1000-9765-val\": \"21\", \"process_no_flag\": \"JP000002\"}, {\"um\": \"5af5\", \"type\": \"0\", \"level\": \"0\", \"qc_no\": \"20170118-a006\", \"remark\": null, \"status\": \"0\", \"mt_code\": \"2ab396d4\", \"mt_name\": \"111222\", \"mt_spec\": \"d553\", \"qc_date\": \"0000-00-00 00:00:00\", \"abc_code\": null, \"batch_no\": \"2016121209404879\", \"mt_price\": \"120.00\", \"order_no\": \"\", \"keyin_date\": \"0000-00-00 00:00:00\", \"keyin_user\": \"\", \"limit_days\": \"10\", \"process_no\": \"a002\", \"product_no\": \"a000000d\", \"qc_user_id\": \"\", \"short_name\": \"\", \"storage_id\": null, \"day_plan_no\": \"a10006424\", \"qc_code_jpg\": \"\", \"mt_spec_desc\": \"111333\", \"order_slv_no\": \"\", \"product_date\": \"2016-12-15 11:23:42\", \"product_name\": \"0x1213\", \"a1000-2131-key\": \" u62bdu7ebf \", \"a1000-2131-val\": \"10\", \"a1000-3026-key\": \"u957fu5ea6\", \"a1000-3026-val\": \"21\", \"a1000-3370-key\": \"u5bbdu5ea6\", \"a1000-3370-val\": \"21\", \"a1000-4802-key\": \"u91cdu91cf\", \"a1000-4802-val\": \"11\", \"a1000-5228-key\": \"u539au5ea6\", \"a1000-5228-val\": \"21\", \"a1000-6046-key\": \"u6c34u5206\", \"a1000-6046-val\": \"21\", \"a1000-9765-key\": \"u5e45u5bbd\", \"a1000-9765-val\": \"21\", \"process_no_flag\": \"JP000003\"}, {\"um\": \"5af5\", \"type\": \"0\", \"level\": \"0\", \"qc_no\": \"20170118-a006\", \"remark\": null, \"status\": \"0\", \"mt_code\": \"2ab396d4\", \"mt_name\": \"111222\", \"mt_spec\": \"d553\", \"qc_date\": \"0000-00-00 00:00:00\", \"abc_code\": null, \"batch_no\": \"2016121209404879\", \"mt_price\": \"120.00\", \"order_no\": \"\", \"keyin_date\": \"0000-00-00 00:00:00\", \"keyin_user\": \"\", \"limit_days\": \"10\", \"process_no\": \"a002\", \"product_no\": \"a000000e\", \"qc_user_id\": \"\", \"short_name\": \"\", \"storage_id\": null, \"day_plan_no\": \"a10006424\", \"qc_code_jpg\": \"\", \"mt_spec_desc\": \"111333\", \"order_slv_no\": \"\", \"product_date\": \"2016-12-15 11:23:42\", \"product_name\": \"0x1213\", \"a1000-2131-key\": \" u62bdu7ebf \", \"a1000-2131-val\": \"10\", \"a1000-3026-key\": \"u957fu5ea6\", \"a1000-3026-val\": \"21\", \"a1000-3370-key\": \"u5bbdu5ea6\", \"a1000-3370-val\": \"21\", \"a1000-4802-key\": \"u91cdu91cf\", \"a1000-4802-val\": \"11\", \"a1000-5228-key\": \"u539au5ea6\", \"a1000-5228-val\": \"21\", \"a1000-6046-key\": \"u6c34u5206\", \"a1000-6046-val\": \"21\", \"a1000-9765-key\": \"u5e45u5bbd\", \"a1000-9765-val\": \"21\", \"process_no_flag\": \"JP000003\"}]}'),(11,'{\"rows\": [{\"um\": \"5af5\", \"type\": \"0\", \"level\": \"0\", \"qc_no\": \"20170118-a006\", \"remark\": null, \"status\": \"0\", \"mt_code\": \"2ab396d4\", \"mt_name\": \"111222\", \"mt_spec\": \"d553\", \"qc_date\": \"0000-00-00 00:00:00\", \"abc_code\": null, \"batch_no\": \"2016121209404879\", \"mt_price\": \"120.00\", \"order_no\": \"\", \"keyin_date\": \"0000-00-00 00:00:00\", \"keyin_user\": \"\", \"limit_days\": \"10\", \"process_no\": \"a002\", \"product_no\": \"a0000007\", \"qc_user_id\": \"\", \"short_name\": \"\", \"storage_id\": null, \"day_plan_no\": \"a10006424\", \"qc_code_jpg\": \"\", \"mt_spec_desc\": \"111333\", \"order_slv_no\": \"\", \"product_date\": \"2016-12-15 11:23:42\", \"product_name\": \"0x1213\", \"a1000-2131-key\": \" u62bdu7ebf \", \"a1000-2131-val\": \"10\", \"a1000-3026-key\": \"u957fu5ea6\", \"a1000-3026-val\": \"21\", \"a1000-3370-key\": \"u5bbdu5ea6\", \"a1000-3370-val\": \"21\", \"a1000-4802-key\": \"u91cdu91cf\", \"a1000-4802-val\": \"11\", \"a1000-5228-key\": \"u539au5ea6\", \"a1000-5228-val\": \"21\", \"a1000-6046-key\": \"u6c34u5206\", \"a1000-6046-val\": \"21\", \"a1000-9765-key\": \"u5e45u5bbd\", \"a1000-9765-val\": \"21\", \"process_no_flag\": \"JP000001\"}, {\"um\": \"5af5\", \"type\": \"0\", \"level\": \"0\", \"qc_no\": \"20170118-a006\", \"remark\": null, \"status\": \"0\", \"mt_code\": \"2ab396d4\", \"mt_name\": \"111222\", \"mt_spec\": \"d553\", \"qc_date\": \"0000-00-00 00:00:00\", \"abc_code\": null, \"batch_no\": \"2016121209404879\", \"mt_price\": \"120.00\", \"order_no\": \"\", \"keyin_date\": \"0000-00-00 00:00:00\", \"keyin_user\": \"\", \"limit_days\": \"10\", \"process_no\": \"a002\", \"product_no\": \"a0000009\", \"qc_user_id\": \"\", \"short_name\": \"\", \"storage_id\": null, \"day_plan_no\": \"a10006424\", \"qc_code_jpg\": \"\", \"mt_spec_desc\": \"111333\", \"order_slv_no\": \"\", \"product_date\": \"2016-12-15 11:23:42\", \"product_name\": \"0x1213\", \"a1000-2131-key\": \" u62bdu7ebf \", \"a1000-2131-val\": \"10\", \"a1000-3026-key\": \"u957fu5ea6\", \"a1000-3026-val\": \"21\", \"a1000-3370-key\": \"u5bbdu5ea6\", \"a1000-3370-val\": \"21\", \"a1000-4802-key\": \"u91cdu91cf\", \"a1000-4802-val\": \"11\", \"a1000-5228-key\": \"u539au5ea6\", \"a1000-5228-val\": \"21\", \"a1000-6046-key\": \"u6c34u5206\", \"a1000-6046-val\": \"21\", \"a1000-9765-key\": \"u5e45u5bbd\", \"a1000-9765-val\": \"21\", \"process_no_flag\": \"JP000002\"}, {\"um\": \"5af5\", \"type\": \"0\", \"level\": \"0\", \"qc_no\": \"20170118-a006\", \"remark\": null, \"status\": \"0\", \"mt_code\": \"2ab396d4\", \"mt_name\": \"111222\", \"mt_spec\": \"d553\", \"qc_date\": \"0000-00-00 00:00:00\", \"abc_code\": null, \"batch_no\": \"2016121209404879\", \"mt_price\": \"120.00\", \"order_no\": \"\", \"keyin_date\": \"0000-00-00 00:00:00\", \"keyin_user\": \"\", \"limit_days\": \"10\", \"process_no\": \"a002\", \"product_no\": \"a000000a\", \"qc_user_id\": \"\", \"short_name\": \"\", \"storage_id\": null, \"day_plan_no\": \"a10006424\", \"qc_code_jpg\": \"\", \"mt_spec_desc\": \"111333\", \"order_slv_no\": \"\", \"product_date\": \"2016-12-15 11:23:42\", \"product_name\": \"0x1213\", \"a1000-2131-key\": \" u62bdu7ebf \", \"a1000-2131-val\": \"10\", \"a1000-3026-key\": \"u957fu5ea6\", \"a1000-3026-val\": \"21\", \"a1000-3370-key\": \"u5bbdu5ea6\", \"a1000-3370-val\": \"21\", \"a1000-4802-key\": \"u91cdu91cf\", \"a1000-4802-val\": \"11\", \"a1000-5228-key\": \"u539au5ea6\", \"a1000-5228-val\": \"21\", \"a1000-6046-key\": \"u6c34u5206\", \"a1000-6046-val\": \"21\", \"a1000-9765-key\": \"u5e45u5bbd\", \"a1000-9765-val\": \"21\", \"process_no_flag\": \"JP000002\"}, {\"um\": \"5af5\", \"type\": \"0\", \"level\": \"0\", \"qc_no\": \"20170118-a006\", \"remark\": null, \"status\": \"0\", \"mt_code\": \"2ab396d4\", \"mt_name\": \"111222\", \"mt_spec\": \"d553\", \"qc_date\": \"0000-00-00 00:00:00\", \"abc_code\": null, \"batch_no\": \"2016121209404879\", \"mt_price\": \"120.00\", \"order_no\": \"\", \"keyin_date\": \"0000-00-00 00:00:00\", \"keyin_user\": \"\", \"limit_days\": \"10\", \"process_no\": \"a002\", \"product_no\": \"a000000b\", \"qc_user_id\": \"\", \"short_name\": \"\", \"storage_id\": null, \"day_plan_no\": \"a10006424\", \"qc_code_jpg\": \"\", \"mt_spec_desc\": \"111333\", \"order_slv_no\": \"\", \"product_date\": \"2016-12-15 11:23:42\", \"product_name\": \"0x1213\", \"a1000-2131-key\": \" u62bdu7ebf \", \"a1000-2131-val\": \"10\", \"a1000-3026-key\": \"u957fu5ea6\", \"a1000-3026-val\": \"21\", \"a1000-3370-key\": \"u5bbdu5ea6\", \"a1000-3370-val\": \"21\", \"a1000-4802-key\": \"u91cdu91cf\", \"a1000-4802-val\": \"11\", \"a1000-5228-key\": \"u539au5ea6\", \"a1000-5228-val\": \"21\", \"a1000-6046-key\": \"u6c34u5206\", \"a1000-6046-val\": \"21\", \"a1000-9765-key\": \"u5e45u5bbd\", \"a1000-9765-val\": \"21\", \"process_no_flag\": \"JP000002\"}, {\"um\": \"5af5\", \"type\": \"0\", \"level\": \"0\", \"qc_no\": \"20170118-a006\", \"remark\": null, \"status\": \"0\", \"mt_code\": \"2ab396d4\", \"mt_name\": \"111222\", \"mt_spec\": \"d553\", \"qc_date\": \"0000-00-00 00:00:00\", \"abc_code\": null, \"batch_no\": \"2016121209404879\", \"mt_price\": \"120.00\", \"order_no\": \"\", \"keyin_date\": \"0000-00-00 00:00:00\", \"keyin_user\": \"\", \"limit_days\": \"10\", \"process_no\": \"a002\", \"product_no\": \"a000000c\", \"qc_user_id\": \"\", \"short_name\": \"\", \"storage_id\": null, \"day_plan_no\": \"a10006424\", \"qc_code_jpg\": \"\", \"mt_spec_desc\": \"111333\", \"order_slv_no\": \"\", \"product_date\": \"2016-12-15 11:23:42\", \"product_name\": \"0x1213\", \"a1000-2131-key\": \" u62bdu7ebf \", \"a1000-2131-val\": \"10\", \"a1000-3026-key\": \"u957fu5ea6\", \"a1000-3026-val\": \"21\", \"a1000-3370-key\": \"u5bbdu5ea6\", \"a1000-3370-val\": \"21\", \"a1000-4802-key\": \"u91cdu91cf\", \"a1000-4802-val\": \"11\", \"a1000-5228-key\": \"u539au5ea6\", \"a1000-5228-val\": \"21\", \"a1000-6046-key\": \"u6c34u5206\", \"a1000-6046-val\": \"21\", \"a1000-9765-key\": \"u5e45u5bbd\", \"a1000-9765-val\": \"21\", \"process_no_flag\": \"JP000002\"}, {\"um\": \"5af5\", \"type\": \"0\", \"level\": \"0\", \"qc_no\": \"20170118-a006\", \"remark\": null, \"status\": \"0\", \"mt_code\": \"2ab396d4\", \"mt_name\": \"111222\", \"mt_spec\": \"d553\", \"qc_date\": \"0000-00-00 00:00:00\", \"abc_code\": null, \"batch_no\": \"2016121209404879\", \"mt_price\": \"120.00\", \"order_no\": \"\", \"keyin_date\": \"0000-00-00 00:00:00\", \"keyin_user\": \"\", \"limit_days\": \"10\", \"process_no\": \"a002\", \"product_no\": \"a000000d\", \"qc_user_id\": \"\", \"short_name\": \"\", \"storage_id\": null, \"day_plan_no\": \"a10006424\", \"qc_code_jpg\": \"\", \"mt_spec_desc\": \"111333\", \"order_slv_no\": \"\", \"product_date\": \"2016-12-15 11:23:42\", \"product_name\": \"0x1213\", \"a1000-2131-key\": \" u62bdu7ebf \", \"a1000-2131-val\": \"10\", \"a1000-3026-key\": \"u957fu5ea6\", \"a1000-3026-val\": \"21\", \"a1000-3370-key\": \"u5bbdu5ea6\", \"a1000-3370-val\": \"21\", \"a1000-4802-key\": \"u91cdu91cf\", \"a1000-4802-val\": \"11\", \"a1000-5228-key\": \"u539au5ea6\", \"a1000-5228-val\": \"21\", \"a1000-6046-key\": \"u6c34u5206\", \"a1000-6046-val\": \"21\", \"a1000-9765-key\": \"u5e45u5bbd\", \"a1000-9765-val\": \"21\", \"process_no_flag\": \"JP000003\"}, {\"um\": \"5af5\", \"type\": \"0\", \"level\": \"0\", \"qc_no\": \"20170118-a006\", \"remark\": null, \"status\": \"0\", \"mt_code\": \"2ab396d4\", \"mt_name\": \"111222\", \"mt_spec\": \"d553\", \"qc_date\": \"0000-00-00 00:00:00\", \"abc_code\": null, \"batch_no\": \"2016121209404879\", \"mt_price\": \"120.00\", \"order_no\": \"\", \"keyin_date\": \"0000-00-00 00:00:00\", \"keyin_user\": \"\", \"limit_days\": \"10\", \"process_no\": \"a002\", \"product_no\": \"a000000e\", \"qc_user_id\": \"\", \"short_name\": \"\", \"storage_id\": null, \"day_plan_no\": \"a10006424\", \"qc_code_jpg\": \"\", \"mt_spec_desc\": \"111333\", \"order_slv_no\": \"\", \"product_date\": \"2016-12-15 11:23:42\", \"product_name\": \"0x1213\", \"a1000-2131-key\": \" u62bdu7ebf \", \"a1000-2131-val\": \"10\", \"a1000-3026-key\": \"u957fu5ea6\", \"a1000-3026-val\": \"21\", \"a1000-3370-key\": \"u5bbdu5ea6\", \"a1000-3370-val\": \"21\", \"a1000-4802-key\": \"u91cdu91cf\", \"a1000-4802-val\": \"11\", \"a1000-5228-key\": \"u539au5ea6\", \"a1000-5228-val\": \"21\", \"a1000-6046-key\": \"u6c34u5206\", \"a1000-6046-val\": \"21\", \"a1000-9765-key\": \"u5e45u5bbd\", \"a1000-9765-val\": \"21\", \"process_no_flag\": \"JP000003\"}]}'),(16,'{\n    \"rows\": [\n        {\n            \"level\": 0,\n            \"product_no\": \"a0000052\",\n            \"qc_option\": [\n                {\n                    \"qc_option_no\": \"a1000-2131\",\n                    \"qc_value\": \"10\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-3026\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-3370\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-4802\",\n                    \"qc_value\": \"11\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-5228\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-6046\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-9765\",\n                    \"qc_value\": \"21\"\n                }\n            ]\n        },\n        {\n            \"level\": 0,\n            \"product_no\": \"a0000053\",\n            \"qc_option\": [\n                {\n                    \"qc_option_no\": \"a1000-2131\",\n                    \"qc_value\": \"10\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-3026\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-3370\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-4802\",\n                    \"qc_value\": \"11\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-5228\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-6046\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-9765\",\n                    \"qc_value\": \"21\"\n                }\n            ]\n        },\n        {\n            \"level\": 0,\n            \"product_no\": \"a0000054\",\n            \"qc_option\": [\n                {\n                    \"qc_option_no\": \"a1000-2131\",\n                    \"qc_value\": \"10\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-3026\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-3370\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-4802\",\n                    \"qc_value\": \"11\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-5228\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-6046\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-9765\",\n                    \"qc_value\": \"21\"\n                }\n            ]\n        },\n        {\n            \"level\": 0,\n            \"product_no\": \"a0000055\",\n            \"qc_option\": [\n                {\n                    \"qc_option_no\": \"a1000-2131\",\n                    \"qc_value\": \"10\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-3026\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-3370\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-4802\",\n                    \"qc_value\": \"11\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-5228\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-6046\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-9765\",\n                    \"qc_value\": \"21\"\n                }\n            ]\n        },\n        {\n            \"level\": 0,\n            \"product_no\": \"a0000056\",\n            \"qc_option\": [\n                {\n                    \"qc_option_no\": \"a1000-2131\",\n                    \"qc_value\": \"10\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-3026\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-3370\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-4802\",\n                    \"qc_value\": \"11\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-5228\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-6046\",\n                    \"qc_value\": \"21\"\n                },\n                {\n                    \"qc_option_no\": \"a1000-9765\",\n                    \"qc_value\": \"21\"\n                }\n            ]\n        }\n    ]\n}');

#
# Structure for table "ym_struct_relation"
#

DROP TABLE IF EXISTS `ym_struct_relation`;
CREATE TABLE `ym_struct_relation` (
  `struct_code` char(6) NOT NULL COMMENT '组织代码',
  `pr_struct_code` char(6) NOT NULL COMMENT '组织名称',
  `remark` varchar(1000) DEFAULT NULL,
  `keyin_user` varchar(100) NOT NULL,
  `keyin_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`struct_code`,`pr_struct_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

#
# Data for table "ym_struct_relation"
#


#
# Structure for table "ym_zone"
#

DROP TABLE IF EXISTS `ym_zone`;
CREATE TABLE `ym_zone` (
  `zone_code` char(20) NOT NULL COMMENT '区域代码',
  `zone_name` varchar(100) NOT NULL COMMENT '名称',
  `short_name` varchar(20) DEFAULT NULL COMMENT '简称',
  `pr_zone_grade` enum('3','2','1','0') NOT NULL COMMENT '父级区域等级',
  `pr_zone_code` varchar(100) NOT NULL COMMENT '父级代码',
  `zone_grade` enum('3','2','1','0') NOT NULL COMMENT '0  世界  1   国家   2 省份  3 县镇',
  `remark` varchar(1000) DEFAULT NULL,
  `keyin_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `keyin_user` varchar(100) NOT NULL,
  PRIMARY KEY (`zone_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='区域设置表';

#
# Data for table "ym_zone"
#

INSERT INTO `ym_zone` VALUES ('0e2c04','广东省','测试01','0','d32e1a','1','','2016-12-20 03:01:29','peter'),('d32e1a4aac422dac5ba9','中国','中国','1','0e2c04','2','','2016-12-20 03:23:01','peter');

#
# Procedure "DOING_QUALITY"
#

DROP PROCEDURE IF EXISTS `DOING_QUALITY`;
CREATE PROCEDURE `DOING_QUALITY`(IN `qc_no` VARCHAR(32),IN `day_plan_no` VARCHAR(32),IN `product_quality` text,IN `keyin_user` VARCHAR(50))
    NO SQL
    DETERMINISTIC
Label_Pro: BEGIN
    DECLARE loop_count INT DEFAULT 0;
    DECLARE qc_loop_count INT DEFAULT 0;
    DECLARE product_item text;
    DECLARE pr_level INT DEFAULT 0;
    DECLARE qualified_count INT DEFAULT 0;
    DECLARE defective_count INT DEFAULT 0;
    DECLARE top_count       INT DEFAULT 0;

    START TRANSACTION;

     /* å¦‚æžœè¡¨ym_qc_batchä¸å­˜åœ¨ day_plan_noçš„è®°å½•ï¼Œåˆ™éœ€è¦æ·»åŠ ä¸€æ¡è®°å½•*/  
    SET @strsql=CONCAT('SET  @plan_count=(SELECT  count(*)  FROM ym_qc_batch  WHERE day_plan_no=\'',day_plan_no,'\')');  
    PREPARE strsql FROM @strsql;   
    EXECUTE strsql; 
    IF @plan_count < 1 THEN
         INSERT INTO `ym_qc_batch`(`qc_no`, `day_plan_no`, `batch_no`, `mt_code`, `um`, `order_no`, `order_slv_no`, `qc_date`, `qualified_count`, `top_count`, `waste_count`, `defective_count`, `total`, `keyin_user`, `keyin_date`)  
                     SELECT * FROM ( SELECT  qc_no as `qc_no`, day_plan_no as `day_plan_no`,`wp`.`batch_no`, `wp`.`mt_code`, `pb`.`um` ,`wp`.`order_no`,`wp`.`order_slv_no`,sysdate(),0 as `qualified_count`, 0 as `top_count`, 0 as `waste_count`, 0 as `defective_count`, `wp`.`finish_qty` as `total`,keyin_user, sysdate() as `keyin_date` FROM  `ym_workday_plan` as `wp` INNER JOIN `ym_product_batch` as `pb` ON `wp`.`batch_no`=`pb`.`batch_no` WHERE `wp`.`day_plan_no`=day_plan_no ) AS t;       
    END IF ; 

    /*SELECT  json_extract(product_quality,'$.rows[0].um') as `www` ; SELECT json_length(product_quality,'$.rows') INTO @count ; */
    SET @count=json_length(product_quality,'$.rows') ;  
    IF @count=0 THEN 
    ...
    SET loop_count=0;
    WHILE loop_count<@count DO
        /*è´¨æ£€äº§å“json*/
        SET @strsql = CONCAT('SELECT json_extract(\'',product_quality,'\'\,\'$.rows[',loop_count,']\') INTO @product_item ;');
        PREPARE strsql FROM @strsql;   
        EXECUTE strsql; 

        /*äº§å“ç¼–å·*/
        SET @strsql = CONCAT('SELECT json_extract(\'',@product_item,'\'\,\'$.product_no\') INTO @product_no');
        PREPARE strsql FROM @strsql;   
        EXECUTE strsql;   

        /*åˆ¤å®šç»“æžœ*/
        SET @strsql = CONCAT('SET @pr_level = json_extract(\'',@product_item,'\'\,\'$.level\') ;');
        PREPARE strsql FROM @strsql;   
        EXECUTE strsql;  

        /*è´¨æ£€é¡¹æ•°*/
        SET @strsql = CONCAT(' SELECT json_length(\'',@product_item,'\'\,\'$.qc_option\') INTO @qc_count ;');  
        PREPARE strsql FROM @strsql;   
        EXECUTE strsql; 

        SET qc_loop_count=0;
        WHILE qc_loop_count < @qc_count DO
            /*è´¨æ£€å‚æ•°  @qc_option  */
            SET @strsql = CONCAT('SELECT json_extract(\'',@product_item,'\'\,\'$.qc_option[',qc_loop_count,']\')  INTO @qc_option ;');
            PREPARE strsql FROM @strsql;   
            EXECUTE strsql; 
            SET @product_no=REPLACE(@product_no,'\"','');

            SET @strsql = CONCAT('SELECT json_extract(\'',@qc_option,'\'\,\'$.qc_option_no\') INTO @qc_option_no ;'); 
            PREPARE strsql FROM @strsql;   
            EXECUTE strsql;  
            SET @qc_option_no=REPLACE(@qc_option_no,'\"','');       

            SET @strsql = CONCAT('SELECT json_extract(\'',@qc_option,'\'\,\'$.qc_value\') INTO @qc_value ;'); 
            PREPARE strsql FROM @strsql;   
            EXECUTE strsql; 
            SET @qc_value=REPLACE(@qc_value,'\"',''); 

            INSERT INTO ym_product_qc_value(`product_no`, `day_plan_no`,`qc_no`, `qc_option_no`, `qc_value`, `keyin_user`, `keyin_date`) 
                                 VALUE (@product_no,day_plan_no,qc_no,@qc_option_no,@qc_value,keyin_user,sysdate());

	    SET @strsql=CONCAT('INSERT INTO ym_product_qc_value(product_no,day_plan_no,qc_no,qc_option_no,qc_value,keyin_user,keyin_date) 
                                 VALUE (\'',@product_no,'\'\,\'',day_plan_no,'\'\,\'',qc_no,'\'\,\'',@qc_option_no,'\'\,\'',@qc_value,'\'\,\'',keyin_user,
				'\'\,\'',sysdate(),'\');');
	    PREPARE strsql FROM @strsql;   
            EXECUTE strsql;
	    /*SELECT  @strsql;*/	

            SET qc_loop_count=qc_loop_count+1;                        
        END WHILE;

        SET @strsql=CONCAT('UPDATE ym_product SET status\=2,qc_no\=\'',qc_no,'\'\,level\=\'',@pr_level,'\' WHERE product_no\=\'',@product_no,'\' ;');
        PREPARE strsql FROM @strsql;  
        EXECUTE strsql; 

        /*åˆæ ¼0  ä¸åˆæ ¼1   -1 æœªè¯„å®š*/
        IF @pr_level=0 THEN  
            SET @strsql=CONCAT('UPDATE ym_qc_batch SET qualified_count\=qualified_count+1,total\=total+1 WHERE day_plan_no\=\'',day_plan_no,'\' ;');
        ELSEIF @pr_level=1 THEN 
            SET @strsql=CONCAT('UPDATE ym_qc_batch SET defective_count\=defective_count+1,total\=total+1 WHERE day_plan_no\=\'',day_plan_no,'\' ;');
        ELSEIF @pr_level=2 THEN 
            SET @strsql=CONCAT('UPDATE ym_qc_batch SET top_count\=top_count+1,total\=total+1 WHERE day_plan_no\=\'',day_plan_no,'\' ;');
        END IF ; 
        PREPARE strsql FROM @strsql;   
        EXECUTE strsql; 
   ...
   /* RESULT_CODEä¸º0 æ“ä½œæˆåŠŸ SELECT `day_plan_no` FROM `ym_product` WHERE `status`=1 AND `day_plan_no`=' åˆ¤æ–­è¿˜æœ‰æ²¡æœ‰æ²¡æœ‰æ£€éªŒçš„äº§å“ï¼Œè¿”å›žRESULT_CODE ä¸º1æœ‰å°±åˆ·è¡Œæœ¬é¡µï¼Œè¿”å›žRESULT_CODE ä¸º2å¦åˆ™è·³è½¬åˆ°ä¸»é¡µ*/
   SET @strsql=CONCAT('SET  @product_count=(SELECT  count(*)  FROM ym_product  WHERE  status=1 AND day_plan_no=\'',day_plan_no,'\') ;');  
   PREPARE strsql FROM @strsql;   
   EXECUTE strsql; 
   IF @product_count > 0 THEN
	SELECT 1 AS RESULT_CODE;
   ELSE
	/*0  å·²å®Œæˆ  1  æœªå¼€å§‹   2  è¿›è¡Œä¸­   3 å»¶è¿Ÿ     5å·²ç»è´¨æ£€   6å®Œæˆ (å…¥åº“) */
	SET @strsql=CONCAT('UPDATE ym_workday_plan SET status = 5 WHERE day_plan_no\=\'',day_plan_no,'\' ;');
	PREPARE strsql FROM @strsql;   
	EXECUTE strsql; 

	SELECT 2 AS RESULT_CODE;
   END IF ; 
...
DROP PROCEDURE IF EXISTS `GET_BOM`;
CREATE PROCEDURE `GET_BOM`(IN mt_code VARCHAR(10))
BEGIN  
      ...
      CREATE  TABLE bom_table 
          ...
          um_name     varchar(50) NOT NULL,  
	        pr_mt_code  char(10) ,
          pr_mt_name  varchar(50),
          src_mt_code char(10),
          child_count   TINYINT(1)
			);

      SET @bom_level = 1;   

			SET @sql1 = 'INSERT bom_table SELECT  mt_code\,(select mt_name from ym_materiel where ym_materiel_bom.mt_code\=ym_materiel.mt_code limit 1) as mt_name\,'; 
      SET @strsql = CONCAT(@sql1  
													 ,@bom_level
													 ,' \,quantity\,um as um_code\,'
													 ,' (select um_name from ym_um where ym_um.um_code\=ym_materiel_bom.um limit 1) as um_name\,'
													 ,' ym_materiel_bom.pr_mt_code as pr_mt_code\,'
													 ,' (select mt_name from ym_materiel where ym_materiel.mt_code\=ym_materiel_bom.pr_mt_code limit 1)as pr_mt_name \,'
													 ,'\''
													 ,mt_code
													 ,'\''
								           ,' \,( select count(cmb.mt_code) as child_count from ym_materiel_bom as cmb where cmb.pr_mt_code\=ym_materiel_bom.mt_code'  
													 ,' ) as child_count from ym_materiel_bom where ym_materiel_bom.pr_mt_code\=\''
													 ,mt_code
													 ,'\'');
      ...
      WHILE  row_count()>0
      DO
							SET @new_level = @bom_level +1;  
							
							SET @strsql  = '';
              SET @strsql = CONCAT('INSERT bom_table'  
																	 ,' SELECT mb.mt_code,(SELECT mt_name from ym_materiel where ym_materiel.mt_code\= mb.mt_code limit 1) as mt_name\,'		
																	 ,@new_level
																	 ,' \,mb.quantity\,mb.um as um_code\,(select um_name from ym_um where ym_um.um_code\=mb.um limit 1) as um_name\,'
																	 ,' mb.pr_mt_code\,'
																	 ,'(SELECT mt_name FROM ym_materiel where ym_materiel.mt_code\=\''
																	 ,mt_code
																	 ,'\''
																	 ,' LIMIT 1) as pr_mt_name\,' 
																	 ,'\''
																	 ,mt_code
																	 ,'\''
																	 ,' \,(select count(mt_code) as child_count from ym_materiel_bom where ym_materiel_bom.pr_mt_code=mb.mt_code) as child_count FROM ym_materiel_bom as mb INNER JOIN bom_table tmb ON mb.pr_mt_code\=tmb.mt_code WHERE bom_level\='
																	 ,@bom_level);
												
							SET @bom_level = @bom_level +1;
							prepare strsql from @strsql;
							execute strsql;
		  END WHILE;


    SELECT * FROM  bom_table ORDER BY bom_level ASC ;
...
DROP PROCEDURE IF EXISTS `GET_QUALITY`;
CREATE PROCEDURE `GET_QUALITY`(IN `product_no` VARCHAR(32))
    NO SQL
    DETERMINISTIC
Label_Pro: BEGIN
    START TRANSACTION;
        SELECT `mt_code` INTO @mt_code  FROM  `ym_product` WHERE `product_no`=product_no limit 1 ; 
        IF  @mt_code IS NOT NULL  THEN
               SELECT *, (SELECT mt_name FROM ym_materiel WHERE mt_code=ym_materiel.mt_code limit 1) as mt_name,(SELECT um_name FROM ym_um WHERE ym_um.um_code=ym_qc_option.um_code limit 1) as um_name,(SELECT qc_value FROM ym_product_qc_value WHERE `product_no`=product_no AND qc_option_no=ym_qc_option.qc_option_no limit 1) as product_qc_value FROM ym_qc_option WHERE `mt_code`=@mt_code ORDER BY item_no ASC; 
        ELSE
                SELECT -1001 AS RESULT_CODE;
                ROLLBACK;
                LEAVE label_pro ;
...
DROP PROCEDURE IF EXISTS `STOAGR_IN`;
CREATE PROCEDURE `STOAGR_IN`(IN `tran_type` varchar(8), IN `mt_code` VARCHAR(32),IN `um` VARCHAR(32),IN `stroage_id` VARCHAR(32),IN `qty` int(11), 
                                                      IN `trans_no` VARCHAR(32),IN `trans_slv_no` VARCHAR(32),    
                                                      IN `in_no` VARCHAR(32),IN `in_slv_no` VARCHAR(32),IN `trans_id` VARCHAR(32),
                                                      IN `keyin_user` VARCHAR(32),IN `products_id_str` VARCHAR(5650))
    NO SQL
    DETERMINISTIC
Label_Pro: BEGIN
    ...
    /*????  0D???????? OE?????? 0F ????????*/
    IF  tran_type ='0D' THEN    /* ??????????     ?????? ???????? ?????*/              
       BEGIN
            SELECT status INTO @status  FROM  ym_workday_plan WHERE day_plan_no=trans_slv_no ;
            IF @status < 4 THEN
                SELECT -1001 AS RESULT_CODE;
                ROLLBACK;
                LEAVE label_pro ;
            ...
            /* ?????????? */
            SELECT `finish_qty` INTO @finish_qty FROM  ym_workday_plan WHERE day_plan_no=trans_slv_no ;
            SELECT  `in_qty` INTO @in_qty FROM  ym_workday_plan WHERE day_plan_no=trans_slv_no ;
            IF  @finish_qty < @in_qty + qty THEN
                SELECT -1002 AS RESULT_CODE;
                ROLLBACK;
                LEAVE label_pro ;
            END IF; 
           
						SET @strsql=CONCAT('UPDATE ym_workday_plan SET in_qty\=if(in_qty is null,0,in_qty)+',qty,' WHERE day_plan_no\=\'',trans_slv_no,'\'');  
						PREPARE strsql FROM @strsql;    
						EXECUTE strsql; 

            IF ROW_COUNT()>0 THEN
               SELECT  `batch_no` INTO @batch_no FROM  ym_workday_plan WHERE day_plan_no=trans_slv_no ;    
               
							 SET @strsql=CONCAT('UPDATE ym_product_batch SET in_qty\=if(in_qty is null,0,in_qty)+',qty,' WHERE batch_no\=\'',@batch_no,'\'');  
						   PREPARE strsql FROM @strsql;    
						   EXECUTE strsql;  
            END IF; 
       END;
    ELSEIF tran_type='0E' THEN
       BEGIN
            /*  ???????????????? ????????? */
            SELECT `mt_num` INTO @mt_num FROM  `ym_purchase_slv`  WHERE `slv_no`=trans_slv_no ;
            SELECT `mt_complete_num` INTO @mt_complete_num FROM  `ym_purchase_slv`  WHERE `slv_no`=trans_slv_no ;
            IF  @mt_num < @mt_complete_num + qty THEN
                SELECT -1002 AS RESULT_CODE;
                ROLLBACK;
                LEAVE label_pro ;
            END IF; 
           
						SET @strsql=CONCAT('UPDATE ym_purchase_slv SET mt_complete_num\=if(mt_complete_num is null,0,mt_complete_num)+',qty,' WHERE slv_no\=\'',trans_slv_no,'\'');  
						PREPARE strsql FROM @strsql;    
						EXECUTE strsql;  
       END;
    ELSEIF tran_type='0F' THEN 
       BEGIN
            /*  ???????????????? ??????????? */
            SELECT `return_qty` INTO @return_qty FROM  `ym_returns_slv`  WHERE `returns_slv_no`=trans_slv_no ; 
            SELECT `in_qty` INTO @in_qty FROM  `ym_returns_slv`  WHERE `returns_slv_no`=trans_slv_no ;  
            IF  @return_qty < @in_qty + qty THEN
                SELECT -1002 AS RESULT_CODE;
                ROLLBACK;
                LEAVE label_pro ;
            END IF; 
           
            /*UPDATE `ym_returns_slv` SET `in_qty`=`in_qty`+qty WHERE `returns_slv_no`=trans_slv_no ;  SELECT @return_qty;SELECT @in_qty; SELECT @strsql;*/
	    SET @strsql=CONCAT('UPDATE ym_returns_slv SET in_qty\=if(in_qty is null,0,in_qty)+',qty,' WHERE returns_slv_no\=\'',trans_slv_no,'\'');  
	    PREPARE strsql FROM @strsql;    
	    EXECUTE strsql;  	
      END;
    ELSE
        BEGIN
            /* ?????????? */
            SELECT -2001 AS RESULT_CODE;
            ROLLBACK;
            LEAVE label_pro ;
        END;
    END IF;

    SELECT ROW_COUNT() INTO @row_affect;
    /* ?????? */
    IF @row_affect>0 THEN
       SET @strsql=CONCAT('INSERT INTO ym_storage_in_slv(in_slv_no\,in_no\,mt_code\,um\,in_qty\,storage_qty\,out_qty\,keyin_date\,',
			  'keyin_user\,trans_id\,flag_id\,trans_type\,trans_no\,trans_slv_no)VALUES(',
			  '\'',in_slv_no,'\'\,\'',in_no,'\'\,\'',mt_code,'\'\,\'',um,'\'\,\'',qty,'\'\,\'',qty,'\'\,\'',0,
			  '\'\,\'',sysdate(),'\'\,\'',keyin_user,'\'\,\'',trans_id,'\'\,\'',0,'\'\,\'',tran_type,
        '\'\,\'',trans_no,'\'\,\'',trans_slv_no,'\')');   
       PREPARE strsql FROM @strsql;   
       EXECUTE strsql;                           
    END IF;  

    /* ????????? 3??????*/
    IF ( products_id_str IS NOT NULL ) OR ( products_id_str !='' ) THEN
       UPDATE `ym_product` SET `status`=3 , `storage_id`=storage_id  WHERE `product_no` in (products_id_str);
    END IF;

    /* ???????? */
    INSERT INTO ym_storage_transaction(trans_id, storage_code, mt_code, um, trans_type, trans_date, trans_qty, trans_no, trans_slv_no, cust_code, to_bill_no, 
                                            to_bill_slv_no, basis_bill_no, basis_bill_slv_no, remark, keyin_user, keyin_date) VALUES 
                                           (trans_id,stroage_id,mt_code,um,tran_type,sysdate(),qty,trans_no,trans_slv_no,'',in_no,
                                            in_slv_no,'','','',keyin_user,sysdate());

    COMMIT;
    /* RESULT_CODE?0 ????    ROLLBACK; */
    SELECT 1 AS RESULT_CODE;
...
#
# Procedure "STOAGR_OUT"
#

DROP PROCEDURE IF EXISTS `STOAGR_OUT`;
CREATE PROCEDURE `STOAGR_OUT`(IN `tran_type` INT(2) UNSIGNED, IN `mt_code` VARCHAR(32),IN `um` VARCHAR(32),IN `stroage_id` VARCHAR(32),IN `qty` int(11), 
                                                      IN `trans_no` VARCHAR(32),IN `trans_slv_no` VARCHAR(32),    
                                                      IN `basis_bill_no` VARCHAR(32),IN `basis_bill_slv_no` VARCHAR(32),IN  `to_bill_no` VARCHAR(32),IN  `to_bill_slv_no` VARCHAR(32),IN `trans_id` VARCHAR(32),
                                                      IN `keyin_user` VARCHAR(32),IN `products_id_str` VARCHAR(5650))
    NO SQL
    DETERMINISTIC
Label_Pro: BEGIN
    ...
    /* 判断库存的量 */
    SELECT storage_qty INTO @storage_qty  FROM  ym_storage_in_slv WHERE in_slv_no=basis_bill_slv_no ;
    IF @storage_qty < qty THEN
        SELECT -1001 AS RESULT_CODE;
        ROLLBACK;
        LEAVE label_pro ;
    END IF; 

    /*事务类型 为 0A 表示领料单出库  0B 表示订单出库 0C 表示采购退货出库 0D表示的是生产入库 OE表示采购入库 0F 表示订单退货入库*/
    IF  tran_type ='0A' THEN    /* 料单出库事务类型处理     先做出库处理 然后添加事务记录 生成出库单*/              
       BEGIN
            /* 不能够超出请求数量 */
            SELECT req_qty INTO @req_qty FROM  ym_product_picking_slv  WHERE picking_slv_code=trans_slv_no ;
            SELECT  real_qty INTO @real_qty FROM  ym_product_picking_slv  WHERE picking_slv_code=trans_slv_no ;
            IF  @req_qty < @real_qty + qty THEN
                SELECT -1002 AS RESULT_CODE;
                ROLLBACK;
                LEAVE label_pro ;
            END IF; 
           
            UPDATE ym_storage_in_slv SET storage_qty=storage_qty-qty,out_qty=out_qty+qty WHERE in_slv_no=basis_bill_slv_no ;
            IF ROW_COUNT()>0 THEN
               UPDATE ym_product_picking_slv SET real_qty=real_qty+qty WHERE picking_slv_code=trans_slv_no ;
            END IF; 
       END;
    ELSEIF tran_type='0B' THEN
       BEGIN
            /*  已经发货的数量加上本次发货的数量 不能够超出订单数量 */
            SELECT order_qty INTO @order_qty FROM  ym_invoice_slv INNER JOIN  ym_order_slv ON ym_invoice_slv.order_slv_no= ym_order_slv.order_slv_no  WHERE invoice_slv_no=trans_slv_no ;
            SELECT  invoice_qty INTO @invoice_qty FROM  ym_invoice_slv  WHERE picking_slv_code=trans_slv_no ;
            IF  @order_qty < @invoice_qty + qty THEN
                SELECT -1002 AS RESULT_CODE;
                ROLLBACK;
                LEAVE label_pro ;
            END IF; 
            ...
            UPDATE ym_storage_in_slv SET storage_qty=storage_qty-qty,out_qty=out_qty+qty WHERE in_slv_no=basis_bill_slv_no ;
            IF ROW_COUNT()>0 THEN
               UPDATE ym_invoice_slv SET invoice_qty=invoice_qty+qty WHERE picking_slv_code=trans_slv_no ;
            END IF;
       END;
    ELSEIF tran_type='0C' THEN
       BEGIN
            SELECT mt_return_num INTO @mt_return_num FROM  ym_purchase_returns_slv   WHERE returns_slv_no=trans_slv_no ;
            SELECT  mt_num INTO @mt_num FROM  ym_invoice_slv  WHERE picking_slv_code=trans_slv_no ;
            IF  @mt_num <@mt_return_num + qty THEN
                SELECT -1002 AS RESULT_CODE;
                ROLLBACK;
                LEAVE label_pro ;
            END IF; 
            ...
            UPDATE ym_storage_in_slv SET storage_qty=storage_qty-qty,out_qty=out_qty+qty WHERE in_slv_no=basis_bill_slv_no ;
            IF ROW_COUNT()>0 THEN
               UPDATE ym_purchase_returns_slv SET mt_return_num=mt_return_num+qty WHERE returns_slv_no=trans_slv_no ;
               UPDATE ym_purchase_slv SET mt_return_num=mt_return_num+qty WHERE  slv_no IN  ( SELECT  slv_no FROM  ym_purchase_returns_slv WHERE  returns_slv_no= trans_slv_no) ;
            END IF;
       END;
    ELSE
        BEGIN
    ...
    /* 插入出库记录 */
    INSERT INTO ym_storage_out_slv(out_no, out_slv_no, mt_code, um, out_qty, remark, keyin_date, keyin_user, trans_id,trans_type,trans_no,trans_slv_no) 
                                        VALUES 
                                       (to_bill_no,to_bill_slv_no,mt_code,um,qty,'',sysdate(),keyin_user,trans_id,tran_type,trans_no,trans_slv_no);
    

     /* 更新产品状态为出库 4表示产品出库 */
    IF (products_id_str IS NOT NULL) OR ( products_id_str !='' ) THEN
       UPDATE ym_product SET status=4,storage_id=''  WHERE product_no in (products_id_str) ;
    END IF;

    /* 插入事务记录 */
    INSERT INTO ym_storage_transaction(trans_id, storage_code, mt_code, um, trans_type, trans_date, trans_qty, trans_no, trans_slv_no, cust_code, to_bill_no, 
                                            to_bill_slv_no, basis_bill_no, basis_bill_slv_no, remark, keyin_user, keyin_date) VALUES 
                                           (trans_id,stroage_id,mt_code,um,'0A',sysdate(),qty,trans_no,trans_slv_no,'',to_bill_no,
                                            to_bill_slv_no,basis_bill_no,basis_bill_slv_no,'',sysdate(),keyin_user); 
...
BEGIN
  ...
  SELECT storage_qty INTO @storage_qty  FROM  ym_storage_in_slv limit 1 ;
  SELECT @storage_qty ;     
